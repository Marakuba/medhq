...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Promotion.total_price'
        db.add_column('promotion_promotion', 'total_price', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Promotion.total_price'
        db.delete_column('promotion_promotion', 'total_price')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 8, 52, 42, 465956)'})
        },
        'pricelist.discount': {
