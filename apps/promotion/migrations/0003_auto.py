...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field state on 'Promotion'
        db.create_table('promotion_promotion_state', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('promotion', models.ForeignKey(orm['promotion.promotion'], null=False)),
            ('state', models.ForeignKey(orm['state.state'], null=False))
        ))
        db.create_unique('promotion_promotion_state', ['promotion_id', 'state_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field state on 'Promotion'
        db.delete_table('promotion_promotion_state')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 11, 44, 38, 397425)'})
        },
        'pricelist.discount': {
