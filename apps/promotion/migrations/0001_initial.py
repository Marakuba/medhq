...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('promotion_promotion', (
        ...
        db.send_create_signal('promotion', ['Promotion'])

        # Adding model 'PromotionItem'
        db.create_table('promotion_promotionitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('promotion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotion.Promotion'])),
        ...
        db.send_create_signal('promotion', ['PromotionItem'])


    def backwards(self, orm):
        
        # Deleting model 'Promotion'
        db.delete_table('promotion_promotion')

        # Deleting model 'PromotionItem'
        db.delete_table('promotion_promotionitem')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 26, 16, 52, 1, 42835)'})
        },
        'pricelist.discount': {
        ...
        'promotion.promotionitem': {
            'Meta': {'object_name': 'PromotionItem'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'promotion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['promotion.Promotion']"})
        },
        'service.baseservice': {
