...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reporting_servicegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=3)),
        ))
        db.send_create_signal('reporting', ['ServiceGroup'])

        # Adding M2M table for field baseservice on 'ServiceGroup'
        db.create_table('reporting_servicegroup_baseservice', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('servicegroup', models.ForeignKey(orm['reporting.servicegroup'], null=False)),
            ('baseservice', models.ForeignKey(orm['service.baseservice'], null=False))
        ))
        db.create_unique('reporting_servicegroup_baseservice', ['servicegroup_id', 'baseservice_id'])

        # Adding model 'StateGroup_State'
        db.create_table('reporting_stategroup_state', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'], unique=True)),
            ('stategroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reporting.StateGroup'])),
        ))
        db.send_create_signal('reporting', ['StateGroup_State'])

        # Adding model 'StateGroup'
        db.create_table('reporting_stategroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
        ))
        db.send_create_signal('reporting', ['StateGroup'])


    def backwards(self, orm):
        
        # Deleting model 'ServiceGroup'
        db.delete_table('reporting_servicegroup')

        # Removing M2M table for field baseservice on 'ServiceGroup'
        db.delete_table('reporting_servicegroup_baseservice')

        # Deleting model 'StateGroup_State'
        db.delete_table('reporting_stategroup_state')

        # Deleting model 'StateGroup'
        db.delete_table('reporting_stategroup')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 5, 2, 5, 16, 915981)'})
        },
