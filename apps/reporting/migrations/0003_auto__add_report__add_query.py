...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table('reporting_report', (
            ...
            ('sql_query', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reporting.Query'], null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('reporting', ['Report'])

        # Adding model 'Query'
        db.create_table('reporting_query', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sql', self.gf('django.db.models.fields.TextField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('reporting', ['Query'])

    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table('reporting_report')

        # Deleting model 'Query'
        db.delete_table('reporting_query')
