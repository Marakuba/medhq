...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.formclass'
        db.add_column('reporting_report', 'formclass',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Report.formclass'
        db.delete_column('reporting_report', 'formclass')
    ...
    models = {
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 4, 0, 0)'})
        },
        'reporting.query': {
