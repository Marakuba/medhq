...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.parent'
        db.add_column('reporting_report', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['reporting.Report']),
                      keep_default=False)

        # Adding field 'Report.lft'
        db.add_column('reporting_report', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Report.rght'
        db.add_column('reporting_report', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Report.tree_id'
        db.add_column('reporting_report', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Report.level'
        db.add_column('reporting_report', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Report.parent'
        db.delete_column('reporting_report', 'parent_id')

        # Deleting field 'Report.lft'
        db.delete_column('reporting_report', 'lft')

        # Deleting field 'Report.rght'
        db.delete_column('reporting_report', 'rght')

        # Deleting field 'Report.tree_id'
        db.delete_column('reporting_report', 'tree_id')

        # Deleting field 'Report.level'
        db.delete_column('reporting_report', 'level')
    ...
    models = {
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 4, 0, 0)'})
        },
        'reporting.query': {
        ...
        'reporting.report': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['reporting.Report']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sql_query': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reporting.Query']", 'null': 'True', 'blank': 'True'}),
            'template': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})
        },
        'reporting.servicegroup': {
            'Meta': {'object_name': 'ServiceGroup'},
            'baseservice': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'servicegroup'", 'symmetrical': 'False', 'to': "orm['service.BaseService']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
