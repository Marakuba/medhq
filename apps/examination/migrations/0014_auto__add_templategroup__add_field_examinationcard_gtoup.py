...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TemplateGroup'
        db.create_table('examination_templategroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('examination', ['TemplateGroup'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TemplateGroup'
        db.delete_table('examination_templategroup')
    ...
    models = {
        ...
        'examination.examinationcard': {
            ...
            'gen_diag': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'gtoup': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['examination.TemplateGroup']", 'null': 'True', 'blank': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 20, 5, 30, 520717)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 20, 5, 30, 49952)'})
        },
