...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExaminationCard.modified'
        db.delete_column('examination_examinationcard', 'modified')

        # Deleting field 'ExaminationCard.print_date'
        db.delete_column('examination_examinationcard', 'print_date')

        # Deleting field 'ExaminationCard.ordered_service'
        db.delete_column('examination_examinationcard', 'ordered_service_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 1, 12, 55, 24, 927621)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 1, 12, 55, 24, 490013)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 1, 12, 55, 24, 931432)', 'null': 'True', 'blank': 'True'}),
