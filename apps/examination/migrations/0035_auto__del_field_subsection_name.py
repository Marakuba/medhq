...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubSection.name'
        db.delete_column('examination_subsection', 'name')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'SubSection.name'
        raise RuntimeError("Cannot reverse this migration. 'SubSection.name' and its values cannot be restored.")
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 16, 10, 44, 25, 957583)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 16, 10, 44, 25, 911112)'})
        },
