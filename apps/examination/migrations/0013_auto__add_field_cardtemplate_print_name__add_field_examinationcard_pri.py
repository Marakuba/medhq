...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardTemplate.print_name'
        db.add_column('examination_cardtemplate', 'print_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.print_name'
        db.add_column('examination_examinationcard', 'print_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardTemplate.print_name'
        db.delete_column('examination_cardtemplate', 'print_name')

        # Deleting field 'ExaminationCard.print_name'
        db.delete_column('examination_examinationcard', 'print_name')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 19, 46, 44, 254770)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 19, 46, 43, 909503)'})
        },
