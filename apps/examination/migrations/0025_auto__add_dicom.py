...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DICOM'
        db.create_table('examination_dicom', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('examination_card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.ExaminationCard'])),
            ('dicom_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('examination', ['DICOM'])


    def backwards(self, orm):
        
        # Deleting model 'DICOM'
        db.delete_table('examination_dicom')
    ...
    models = {
        ...
        'examination.dicom': {
            ...
            'dicom_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 13, 17, 26, 24, 266241)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 13, 17, 26, 24, 238470)'})
        },
