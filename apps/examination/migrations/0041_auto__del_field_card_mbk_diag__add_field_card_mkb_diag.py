...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Card.mbk_diag'
        db.delete_column('examination_card', 'mbk_diag_id')

        # Adding field 'Card.mkb_diag'
        db.add_column('examination_card', 'mkb_diag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ICD10'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Card.mbk_diag'
        db.add_column('examination_card', 'mbk_diag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ICD10'], null=True, blank=True), keep_default=False)

        # Deleting field 'Card.mkb_diag'
        db.delete_column('examination_card', 'mkb_diag_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 28, 18, 44, 22, 161858)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 28, 18, 44, 22, 111336)'})
        },
