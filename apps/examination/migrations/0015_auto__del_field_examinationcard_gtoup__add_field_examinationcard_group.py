...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExaminationCard.gtoup'
        db.delete_column('examination_examinationcard', 'gtoup_id')

        # Adding field 'ExaminationCard.group'
        db.add_column('examination_examinationcard', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.TemplateGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ExaminationCard.gtoup'
        db.add_column('examination_examinationcard', 'gtoup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.TemplateGroup'], null=True, blank=True), keep_default=False)

        # Deleting field 'ExaminationCard.group'
        db.delete_column('examination_examinationcard', 'group_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 20, 37, 29, 409302)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 20, 37, 29, 64363)'})
        },
