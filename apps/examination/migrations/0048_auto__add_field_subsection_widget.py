...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubSection.widget'
        db.add_column('examination_subsection', 'widget',
                      self.gf('django.db.models.fields.CharField')(default='textticket', max_length=30),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SubSection.widget'
        db.delete_column('examination_subsection', 'widget')
    ...
    models = {
        ...
        'examination.subsection': {
            ...
            'title': ('django.db.models.fields.TextField', [], {}),
            'widget': ('django.db.models.fields.CharField', [], {'default': "'textticket'", 'max_length': '30'})
        },
