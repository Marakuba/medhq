...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExaminationDetail'
        db.create_table('examination_examinationdetail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exam_card', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['examination.ExaminationCard'], unique=True)),
            ('equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Equipment'], null=True, blank=True)),
            ('area', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('scan_mode', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('thickness', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('width', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('contrast_enhancement', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('examination', ['ExaminationDetail'])

        # Adding field 'ExaminationCard.icd'
        db.add_column('examination_examinationcard', 'icd', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ICD10'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ExaminationDetail'
        db.delete_table('examination_examinationdetail')

        # Deleting field 'ExaminationCard.icd'
        db.delete_column('examination_examinationcard', 'icd_id')
    ...
    models = {
        ...
        'examination.examinationdetail': {
            'Meta': {'object_name': 'ExaminationDetail'},
            'area': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'contrast_enhancement': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'equipment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['examination.Equipment']", 'null': 'True', 'blank': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 24, 16, 3, 44, 274932)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 24, 16, 3, 44, 230309)'})
        },
