...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DICOM.dicom_file'
        db.alter_column('examination_dicom', 'dicom_file', self.gf('django.db.models.fields.files.FileField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'DICOM.dicom_file'
        db.alter_column('examination_dicom', 'dicom_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 13, 17, 30, 57, 495856)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 13, 17, 30, 57, 468024)'})
        },
