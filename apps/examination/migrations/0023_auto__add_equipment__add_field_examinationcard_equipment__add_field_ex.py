...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('examination_equipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('examination', ['Equipment'])

        # Adding field 'ExaminationCard.equipment'
        db.add_column('examination_examinationcard', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Equipment'], null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.area'
        db.add_column('examination_examinationcard', 'area', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.scan_mode'
        db.add_column('examination_examinationcard', 'scan_mode', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.thickness'
        db.add_column('examination_examinationcard', 'thickness', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.width'
        db.add_column('examination_examinationcard', 'width', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.contrast_enhancement'
        db.add_column('examination_examinationcard', 'contrast_enhancement', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Equipment'
        db.delete_table('examination_equipment')

        # Deleting field 'ExaminationCard.equipment'
        db.delete_column('examination_examinationcard', 'equipment_id')

        # Deleting field 'ExaminationCard.area'
        db.delete_column('examination_examinationcard', 'area')

        # Deleting field 'ExaminationCard.scan_mode'
        db.delete_column('examination_examinationcard', 'scan_mode')

        # Deleting field 'ExaminationCard.thickness'
        db.delete_column('examination_examinationcard', 'thickness')

        # Deleting field 'ExaminationCard.width'
        db.delete_column('examination_examinationcard', 'width')

        # Deleting field 'ExaminationCard.contrast_enhancement'
        db.delete_column('examination_examinationcard', 'contrast_enhancement')
    ...
    models = {
        ...
        'examination.cardtemplate': {
            'Meta': {'ordering': "('group', 'staff', 'id')", 'object_name': 'CardTemplate'},
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 21, 35, 26, 336276)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 21, 35, 26, 297409)'})
        },
