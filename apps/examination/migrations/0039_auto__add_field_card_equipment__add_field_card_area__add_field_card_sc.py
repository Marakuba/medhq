...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Card.equipment'
        db.add_column('examination_card', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Equipment'], null=True, blank=True), keep_default=False)

        # Adding field 'Card.area'
        db.add_column('examination_card', 'area', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Card.scan_mode'
        db.add_column('examination_card', 'scan_mode', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Card.thickness'
        db.add_column('examination_card', 'thickness', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Card.width'
        db.add_column('examination_card', 'width', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Card.contrast_enhancement'
        db.add_column('examination_card', 'contrast_enhancement', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Template.equipment'
        db.add_column('examination_template', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Equipment'], null=True, blank=True), keep_default=False)

        # Adding field 'Template.area'
        db.add_column('examination_template', 'area', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Template.scan_mode'
        db.add_column('examination_template', 'scan_mode', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Template.thickness'
        db.add_column('examination_template', 'thickness', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Template.width'
        db.add_column('examination_template', 'width', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Template.contrast_enhancement'
        db.add_column('examination_template', 'contrast_enhancement', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Card.equipment'
        db.delete_column('examination_card', 'equipment_id')

        # Deleting field 'Card.area'
        db.delete_column('examination_card', 'area')

        # Deleting field 'Card.scan_mode'
        db.delete_column('examination_card', 'scan_mode')

        # Deleting field 'Card.thickness'
        db.delete_column('examination_card', 'thickness')

        # Deleting field 'Card.width'
        db.delete_column('examination_card', 'width')

        # Deleting field 'Card.contrast_enhancement'
        db.delete_column('examination_card', 'contrast_enhancement')

        # Deleting field 'Template.equipment'
        db.delete_column('examination_template', 'equipment_id')

        # Deleting field 'Template.area'
        db.delete_column('examination_template', 'area')

        # Deleting field 'Template.scan_mode'
        db.delete_column('examination_template', 'scan_mode')

        # Deleting field 'Template.thickness'
        db.delete_column('examination_template', 'thickness')

        # Deleting field 'Template.width'
        db.delete_column('examination_template', 'width')

        # Deleting field 'Template.contrast_enhancement'
        db.delete_column('examination_template', 'contrast_enhancement')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 25, 15, 42, 57, 344906)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 25, 15, 42, 57, 296934)'})
        },
