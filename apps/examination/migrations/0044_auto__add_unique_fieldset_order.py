...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FieldSet', fields ['order']
        db.create_unique('examination_fieldset', ['order'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FieldSet', fields ['order']
        db.delete_unique('examination_fieldset', ['order'])
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 12, 0, 52, 589934)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 12, 0, 52, 535200)'})
        },
