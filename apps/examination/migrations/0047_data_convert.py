...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        def convert_data(old_data=None,old_quests=None):
            data = []
            if old_data:
                text_data = {
                    'type':'text',
            ...
            if old_quests:
                quests = json.loads(old_quests)
                quest_data = {
                    'type':'questionnaire',
                    'data':[{'name':n,'code':quests[n]['code'],'data':quests[n]['data']} for n in quests]
                }
        ...
        for card in orm.Card.objects.all():
            card.data = convert_data(card.data,card.questionnaire)
            card.save()
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 0, 0)'})
        },
