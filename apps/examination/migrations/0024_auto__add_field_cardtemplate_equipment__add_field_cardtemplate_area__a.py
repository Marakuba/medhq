...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardTemplate.equipment'
        db.add_column('examination_cardtemplate', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Equipment'], null=True, blank=True), keep_default=False)

        # Adding field 'CardTemplate.area'
        db.add_column('examination_cardtemplate', 'area', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CardTemplate.scan_mode'
        db.add_column('examination_cardtemplate', 'scan_mode', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CardTemplate.thickness'
        db.add_column('examination_cardtemplate', 'thickness', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CardTemplate.width'
        db.add_column('examination_cardtemplate', 'width', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CardTemplate.contrast_enhancement'
        db.add_column('examination_cardtemplate', 'contrast_enhancement', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardTemplate.equipment'
        db.delete_column('examination_cardtemplate', 'equipment_id')

        # Deleting field 'CardTemplate.area'
        db.delete_column('examination_cardtemplate', 'area')

        # Deleting field 'CardTemplate.scan_mode'
        db.delete_column('examination_cardtemplate', 'scan_mode')

        # Deleting field 'CardTemplate.thickness'
        db.delete_column('examination_cardtemplate', 'thickness')

        # Deleting field 'CardTemplate.width'
        db.delete_column('examination_cardtemplate', 'width')

        # Deleting field 'CardTemplate.contrast_enhancement'
        db.delete_column('examination_cardtemplate', 'contrast_enhancement')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 22, 19, 12, 824598)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 11, 22, 19, 12, 796223)'})
        },
