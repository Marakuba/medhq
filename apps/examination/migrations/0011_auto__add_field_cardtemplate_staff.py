...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardTemplate.staff'
        db.add_column('examination_cardtemplate', 'staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardTemplate.staff'
        db.delete_column('examination_cardtemplate', 'staff_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 7, 16, 6, 13, 598916)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 7, 16, 6, 13, 144207)'})
        },
