...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExaminationCard.extra_service'
        db.delete_column('examination_examinationcard', 'extra_service')

        # Adding field 'ExaminationCard.conclusion'
        db.add_column('examination_examinationcard', 'conclusion', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.comment'
        db.add_column('examination_examinationcard', 'comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ExaminationCard.extra_service'
        db.add_column('examination_examinationcard', 'extra_service', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'ExaminationCard.conclusion'
        db.delete_column('examination_examinationcard', 'conclusion')

        # Deleting field 'ExaminationCard.comment'
        db.delete_column('examination_examinationcard', 'comment')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 18, 44, 22, 990751)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 18, 44, 22, 535965)'})
        },
