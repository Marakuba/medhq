...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for p in orm.ExaminationCard.objects.all():
            ...
            orm.ExaminationDetail.objects.create(exam_card = p,\
                                                  ...
                                                  width = p.width,\
                                                  contrast_enhancement = p.contrast_enhancement)
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 24, 17, 5, 54, 679663)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 24, 17, 5, 54, 634252)'})
        },
