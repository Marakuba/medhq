...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExaminationCard.assistant'
        db.add_column('examination_examinationcard', 'assistant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExaminationCard.assistant'
        db.delete_column('examination_examinationcard', 'assistant_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 28, 12, 4, 2, 509223)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 28, 12, 4, 2, 234514)'})
        },
