...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('examination_questionnaire', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('code', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('examination', ['Questionnaire'])

        # Adding M2M table for field staff on 'Questionnaire'
        db.create_table('examination_questionnaire_staff', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('questionnaire', models.ForeignKey(orm['examination.questionnaire'], null=False)),
            ('staff', models.ForeignKey(orm['staff.staff'], null=False))
        ))
        db.create_unique('examination_questionnaire_staff', ['questionnaire_id', 'staff_id'])

        # Adding M2M table for field base_service on 'Questionnaire'
        db.create_table('examination_questionnaire_base_service', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('questionnaire', models.ForeignKey(orm['examination.questionnaire'], null=False)),
            ('baseservice', models.ForeignKey(orm['service.baseservice'], null=False))
        ))
        db.create_unique('examination_questionnaire_base_service', ['questionnaire_id', 'baseservice_id'])

    def backwards(self, orm):
        # Deleting model 'Questionnaire'
        db.delete_table('examination_questionnaire')

        # Removing M2M table for field staff on 'Questionnaire'
        db.delete_table('examination_questionnaire_staff')

        # Removing M2M table for field base_service on 'Questionnaire'
        db.delete_table('examination_questionnaire_base_service')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 18, 0, 0)'})
        },
