...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardTemplate.complaints'
        db.add_column('examination_cardtemplate', 'complaints', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CardTemplate.anamnesis'
        db.add_column('examination_cardtemplate', 'anamnesis', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CardTemplate.ekg'
        db.add_column('examination_cardtemplate', 'ekg', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExaminationCard.ekg'
        db.add_column('examination_examinationcard', 'ekg', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardTemplate.complaints'
        db.delete_column('examination_cardtemplate', 'complaints')

        # Deleting field 'CardTemplate.anamnesis'
        db.delete_column('examination_cardtemplate', 'anamnesis')

        # Deleting field 'CardTemplate.ekg'
        db.delete_column('examination_cardtemplate', 'ekg')

        # Deleting field 'ExaminationCard.ekg'
        db.delete_column('examination_examinationcard', 'ekg')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 12, 51, 42, 521371)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 12, 51, 41, 895692)'})
        },
