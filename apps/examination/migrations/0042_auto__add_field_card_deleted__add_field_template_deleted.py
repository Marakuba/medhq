...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('examination_card', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Template.deleted'
        db.add_column('examination_template', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Card.deleted'
        db.delete_column('examination_card', 'deleted')

        # Deleting field 'Template.deleted'
        db.delete_column('examination_template', 'deleted')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 21, 12, 47, 23, 11880)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 21, 12, 47, 22, 956133)'})
        },
