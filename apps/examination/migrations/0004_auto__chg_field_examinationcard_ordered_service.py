...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExaminationCard.ordered_service'
        db.alter_column('examination_examinationcard', 'ordered_service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.OrderedService'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ExaminationCard.ordered_service'
        raise RuntimeError("Cannot reverse this migration. 'ExaminationCard.ordered_service' and its values cannot be restored.")
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 1, 14, 0, 36, 219562)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 1, 14, 0, 35, 851256)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 1, 14, 0, 36, 224635)', 'null': 'True', 'blank': 'True'}),
