...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('examination_cardtemplate', 'complication', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.concomitant_diag'
        db.alter_column('examination_cardtemplate', 'concomitant_diag', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.gen_diag'
        db.alter_column('examination_cardtemplate', 'gen_diag', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.name'
        db.alter_column('examination_cardtemplate', 'name', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.objective_data'
        db.alter_column('examination_cardtemplate', 'objective_data', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.clinical_diag'
        db.alter_column('examination_cardtemplate', 'clinical_diag', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.treatment'
        db.alter_column('examination_cardtemplate', 'treatment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.referral'
        db.alter_column('examination_cardtemplate', 'referral', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CardTemplate.psycho_status'
        db.alter_column('examination_cardtemplate', 'psycho_status', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.complication'
        db.alter_column('examination_examinationcard', 'complication', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.concomitant_diag'
        db.alter_column('examination_examinationcard', 'concomitant_diag', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.gen_diag'
        db.alter_column('examination_examinationcard', 'gen_diag', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.objective_data'
        db.alter_column('examination_examinationcard', 'objective_data', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.disease'
        db.alter_column('examination_examinationcard', 'disease', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.clinical_diag'
        db.alter_column('examination_examinationcard', 'clinical_diag', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.history'
        db.alter_column('examination_examinationcard', 'history', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.anamnesis'
        db.alter_column('examination_examinationcard', 'anamnesis', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.extra_service'
        db.alter_column('examination_examinationcard', 'extra_service', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.complaints'
        db.alter_column('examination_examinationcard', 'complaints', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.referral'
        db.alter_column('examination_examinationcard', 'referral', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExaminationCard.psycho_status'
        db.alter_column('examination_examinationcard', 'psycho_status', self.gf('django.db.models.fields.TextField')(null=True))
        ...
        db.alter_column('examination_examinationcard', 'treatment', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'CardTemplate.complication'
        db.alter_column('examination_cardtemplate', 'complication', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'CardTemplate.concomitant_diag'
        db.alter_column('examination_cardtemplate', 'concomitant_diag', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'CardTemplate.gen_diag'
        db.alter_column('examination_cardtemplate', 'gen_diag', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'CardTemplate.name'
        db.alter_column('examination_cardtemplate', 'name', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'CardTemplate.objective_data'
        db.alter_column('examination_cardtemplate', 'objective_data', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'CardTemplate.clinical_diag'
        db.alter_column('examination_cardtemplate', 'clinical_diag', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'CardTemplate.treatment'
        db.alter_column('examination_cardtemplate', 'treatment', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'CardTemplate.referral'
        db.alter_column('examination_cardtemplate', 'referral', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'CardTemplate.psycho_status'
        db.alter_column('examination_cardtemplate', 'psycho_status', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'ExaminationCard.complication'
        db.alter_column('examination_examinationcard', 'complication', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.concomitant_diag'
        db.alter_column('examination_examinationcard', 'concomitant_diag', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.gen_diag'
        db.alter_column('examination_examinationcard', 'gen_diag', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.objective_data'
        db.alter_column('examination_examinationcard', 'objective_data', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.disease'
        db.alter_column('examination_examinationcard', 'disease', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.clinical_diag'
        db.alter_column('examination_examinationcard', 'clinical_diag', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.history'
        db.alter_column('examination_examinationcard', 'history', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.anamnesis'
        db.alter_column('examination_examinationcard', 'anamnesis', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.extra_service'
        db.alter_column('examination_examinationcard', 'extra_service', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.complaints'
        db.alter_column('examination_examinationcard', 'complaints', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.referral'
        db.alter_column('examination_examinationcard', 'referral', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.psycho_status'
        db.alter_column('examination_examinationcard', 'psycho_status', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'ExaminationCard.mbk_diag'
        db.alter_column('examination_examinationcard', 'mbk_diag', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

        # Changing field 'ExaminationCard.treatment'
        db.alter_column('examination_examinationcard', 'treatment', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))
    ...
    models = {
        ...
        'examination.examinationcard': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mbk_diag': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 5, 12, 6, 26, 593372)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 5, 12, 6, 26, 242579)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 5, 12, 6, 26, 597053)', 'null': 'True', 'blank': 'True'}),
