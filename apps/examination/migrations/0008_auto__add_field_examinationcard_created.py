...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExaminationCard.created'
        db.add_column('examination_examinationcard', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 7, 7, 0, 34, 29, 198851), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExaminationCard.created'
        db.delete_column('examination_examinationcard', 'created')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 7, 0, 34, 18, 521622)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 7, 0, 34, 18, 160106)'})
        },
