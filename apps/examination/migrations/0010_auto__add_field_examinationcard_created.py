...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('examination_examinationcard', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 7, 7, 0, 41, 51, 790854), blank=True), keep_default=False)
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 7, 0, 41, 41, 473608)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 7, 0, 41, 41, 125778)'})
        },
