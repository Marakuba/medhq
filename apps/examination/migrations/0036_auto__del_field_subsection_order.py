...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubSection.order'
        db.delete_column('examination_subsection', 'order')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'SubSection.order'
        raise RuntimeError("Cannot reverse this migration. 'SubSection.order' and its values cannot be restored.")
    ...
    models = {
        ...
        'examination.subsection': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'SubSection'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 16, 11, 24, 0, 43890)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 16, 11, 23, 59, 998050)'})
        },
