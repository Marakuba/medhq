...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.base_service'
        db.alter_column('examination_template', 'base_service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Template.base_service'
        raise RuntimeError("Cannot reverse this migration. 'Template.base_service' and its values cannot be restored.")
    ...
    models = {
        ...
        'examination.fieldset': {
            'Meta': {'ordering': "('id',)", 'object_name': 'FieldSet'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 21, 13, 30, 31, 13274)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 21, 13, 30, 30, 967218)'})
        },
