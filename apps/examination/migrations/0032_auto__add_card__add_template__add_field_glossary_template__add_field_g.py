...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Card'
        db.create_table('examination_card', (
            ...
            ('ordered_service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.OrderedService'], null=True, blank=True)),
            ('assistant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True, blank=True)),
            ('data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('examination', ['Card'])

        # Adding model 'Template'
        db.create_table('examination_template', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('print_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('examination', ['Template'])

        # Adding field 'Glossary.template'
        db.add_column('examination_glossary', 'template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Template'], null=True, blank=True), keep_default=False)

        # Adding field 'Glossary.section'
        db.add_column('examination_glossary', 'section', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Glossary.staff'
        db.alter_column('examination_glossary', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Staff'], null=True))


    def backwards(self, orm):
        
        # Deleting model 'Card'
        db.delete_table('examination_card')

        # Deleting model 'Template'
        db.delete_table('examination_template')

        # Deleting field 'Glossary.template'
        db.delete_column('examination_glossary', 'template_id')

        # Deleting field 'Glossary.section'
        db.delete_column('examination_glossary', 'section')

        # Changing field 'Glossary.staff'
        db.alter_column('examination_glossary', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True))
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 11, 14, 12, 13, 929028)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 11, 14, 12, 13, 813190)'})
        },
