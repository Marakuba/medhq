...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('examination_examinationcard', 'mbk_diag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ICD10'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('examination_examinationcard', 'mbk_diag_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 8, 23, 38, 59, 660073)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 8, 23, 38, 59, 331611)'})
        },
