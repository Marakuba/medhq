...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('examination_glossary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Glossary'], null=True, blank=True)),
            ('base_service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'], null=True, blank=True)),
        ...
        db.send_create_signal('examination', ['Glossary'])


    def backwards(self, orm):
        
        # Deleting model 'Glossary'
        db.delete_table('examination_glossary')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 25, 12, 59, 58, 408311)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 25, 12, 59, 58, 362653)'})
        },
