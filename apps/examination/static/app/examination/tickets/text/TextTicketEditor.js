    ...
    initComponent: function(){
        ...
        this.bodyField = new Ext.ux.TinyMCE({
            ...
            tinymceSettings: {
                ...
                content_css: WebApp.MEDIA_URL+'app/examination/tickets/text/editor.css',
                plugins: "pagebreak,style,layer,table,advhr,advimage,advlink,emotions,insertdatetime,preview,media,searchreplace,print,paste,directionality,noneditable,visualchars,nonbreaking,xhtmlxtras,template",
