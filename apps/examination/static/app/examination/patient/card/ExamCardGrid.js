!(function(){
    ...
    App.examination.ExamCardGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    /*              items:[
            ...
            App.examination.ExamCardGrid.superclass.initComponent.apply(this, arguments);
    ...
    Ext.reg('cardexamgrid',App.examination.ExamCardGrid);

    if(!window['PatientCard']){
        window['PatientCard'] = [];
    }
    window.PatientCard.push(['cardexamgrid', {}]);
