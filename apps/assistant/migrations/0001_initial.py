...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExamAssistant'
        db.create_table('assistant_examassistant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Card'])),
            ('assistant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'])),
        ))
        db.send_create_signal('assistant', ['ExamAssistant'])

        # Adding unique constraint on 'ExamAssistant', fields ['card', 'assistant']
        db.create_unique('assistant_examassistant', ['card_id', 'assistant_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ExamAssistant', fields ['card', 'assistant']
        db.delete_unique('assistant_examassistant', ['card_id', 'assistant_id'])

        # Deleting model 'ExamAssistant'
        db.delete_table('assistant_examassistant')


    models = {
        'assistant.examassistant': {
            'Meta': {'ordering': "('-card__created',)", 'unique_together': "(['card', 'assistant'],)", 'object_name': 'ExamAssistant'},
            'assistant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['staff.Position']"}),
            'card': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['examination.Card']"}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 10, 12, 15, 44, 780963)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 10, 12, 15, 44, 745742)'})
        },
