...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabServiceGroup.template'
        db.add_column('service_labservicegroup', 'template', self.gf('django.db.models.fields.CharField')(default='print/lab/results.html', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabServiceGroup.template'
        db.delete_column('service_labservicegroup', 'template')
