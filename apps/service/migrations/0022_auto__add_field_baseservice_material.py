...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('service_baseservice', 'material', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.Material'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseService.material'
        db.delete_column('service_baseservice', 'material_id')
