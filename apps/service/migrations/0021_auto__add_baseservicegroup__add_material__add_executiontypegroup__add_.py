...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BaseServiceGroup'
        db.create_table('service_baseservicegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('service', ['BaseServiceGroup'])

        # Adding model 'Material'
        db.create_table('service_material', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('service', ['Material'])

        # Adding model 'ExecutionTypeGroup'
        db.create_table('service_executiontypegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('service', ['ExecutionTypeGroup'])

        # Adding model 'LabServiceGroup'
        db.create_table('service_labservicegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('service', ['LabServiceGroup'])

        # Deleting field 'BaseService.material'
        db.delete_column('service_baseservice', 'material')

        # Deleting field 'BaseService.test_form_detail'
        db.delete_column('service_baseservice', 'test_form_detail')

        # Adding field 'BaseService.base_group'
        db.add_column('service_baseservice', 'base_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseServiceGroup'], null=True, blank=True), keep_default=False)

        # Adding field 'BaseService.lab_group'
        db.add_column('service_baseservice', 'lab_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.LabServiceGroup'], null=True, blank=True), keep_default=False)

        # Adding field 'BaseService.execution_type_group'
        db.add_column('service_baseservice', 'execution_type_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ExecutionTypeGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'BaseServiceGroup'
        db.delete_table('service_baseservicegroup')

        # Deleting model 'Material'
        db.delete_table('service_material')

        # Deleting model 'ExecutionTypeGroup'
        db.delete_table('service_executiontypegroup')

        # Deleting model 'LabServiceGroup'
        db.delete_table('service_labservicegroup')

        # Adding field 'BaseService.material'
        db.add_column('service_baseservice', 'material', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'BaseService.base_group'
        db.delete_column('service_baseservice', 'base_group_id')

        # Deleting field 'BaseService.lab_group'
        db.delete_column('service_baseservice', 'lab_group_id')

        # Deleting field 'BaseService.execution_type_group'
        db.delete_column('service_baseservice', 'execution_type_group_id')
