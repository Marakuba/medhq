...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseService.code'
        db.alter_column('service_baseservice', 'code', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # Changing field 'BaseService.code'
        db.alter_column('service_baseservice', 'code', self.gf('django.db.models.fields.CharField')(max_length=25))
