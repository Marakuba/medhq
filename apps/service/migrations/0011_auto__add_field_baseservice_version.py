...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseService.version'
        db.add_column('service_baseservice', 'version', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseService.version'
        db.delete_column('service_baseservice', 'version')
