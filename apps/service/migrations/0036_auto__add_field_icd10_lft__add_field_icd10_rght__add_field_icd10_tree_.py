...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ICD10.lft'
        db.add_column('service_icd10', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)

        # Adding field 'ICD10.rght'
        db.add_column('service_icd10', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)

        # Adding field 'ICD10.tree_id'
        db.add_column('service_icd10', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)

        # Adding field 'ICD10.level'
        db.add_column('service_icd10', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ICD10.lft'
        db.delete_column('service_icd10', 'lft')

        # Deleting field 'ICD10.rght'
        db.delete_column('service_icd10', 'rght')

        # Deleting field 'ICD10.tree_id'
        db.delete_column('service_icd10', 'tree_id')

        # Deleting field 'ICD10.level'
        db.delete_column('service_icd10', 'level')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 8, 22, 19, 7, 15851)'})
        },
        'service.baseservice': {
