...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseService.partnership'
        db.add_column('service_baseservice', 'partnership', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseService.partnership'
        db.delete_column('service_baseservice', 'partnership')
