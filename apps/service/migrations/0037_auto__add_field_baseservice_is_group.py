...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseService.is_group'
        db.add_column('service_baseservice', 'is_group', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseService.is_group'
        db.delete_column('service_baseservice', 'is_group')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 21, 17, 11, 30, 832740)'})
        },
        'service.baseservice': {
