...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtendedService'
        db.create_table('service_extendedservice', (
            ...
            ('tube', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tube', null=True, to=orm['lab.Tube'])),
            ('tube_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('manual', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('service', ['ExtendedService'])

        # Adding M2M table for field staff on 'ExtendedService'
        db.create_table('service_extendedservice_staff', (
        ...
        db.create_unique('service_extendedservice_staff', ['extendedservice_id', 'position_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ExtendedService'
        db.delete_table('service_extendedservice')

        # Removing M2M table for field staff on 'ExtendedService'
        db.delete_table('service_extendedservice_staff')

        # Adding field 'BaseService.tube'
        db.add_column('service_baseservice', 'tube', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tube', null=True, to=orm['lab.Tube'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 5, 18, 33, 16, 428689)'})
        },
        'service.baseservice': {
