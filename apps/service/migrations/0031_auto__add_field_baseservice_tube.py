...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseService.tube'
        db.add_column('service_baseservice', 'tube', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tube', null=True, to=orm['lab.Tube']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseService.tube'
        db.delete_column('service_baseservice', 'tube_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 4, 19, 54, 49, 669407)'})
        },
        'service.baseservice': {
