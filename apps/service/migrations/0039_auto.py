...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field branches on 'ExtendedService'
        db.create_table('service_extendedservice_branches', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('extendedservice', models.ForeignKey(orm['service.extendedservice'], null=False)),
            ('state', models.ForeignKey(orm['state.state'], null=False))
        ))
        db.create_unique('service_extendedservice_branches', ['extendedservice_id', 'state_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field branches on 'ExtendedService'
        db.delete_table('service_extendedservice_branches')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 28, 11, 57, 4, 157635)'})
        },
        'service.baseservice': {
