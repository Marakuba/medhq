...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseService.type'
        db.add_column('service_baseservice', 'type',
                      self.gf('django.db.models.fields.CharField')(default=u'cons', max_length=10),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BaseService.type'
        db.delete_column('service_baseservice', 'type')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 0, 0)'})
        },
        'service.baseservice': {
