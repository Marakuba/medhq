...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseService.single_tube'
        db.add_column('service_baseservice', 'single_tube', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'BaseService.manual'
        db.add_column('service_baseservice', 'manual', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'BaseService.inner_template'
        db.add_column('service_baseservice', 'inner_template', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseService.single_tube'
        db.delete_column('service_baseservice', 'single_tube')

        # Deleting field 'BaseService.manual'
        db.delete_column('service_baseservice', 'manual')

        # Deleting field 'BaseService.inner_template'
        db.delete_column('service_baseservice', 'inner_template')
    ...
    models = {
        ...
        'service.baseservice': {
            ...
            'single_tube': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
