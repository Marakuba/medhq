...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseService.execution_time'
        db.alter_column('service_baseservice', 'execution_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'BaseService.execution_time'
        db.alter_column('service_baseservice', 'execution_time', self.gf('django.db.models.fields.PositiveIntegerField')())
