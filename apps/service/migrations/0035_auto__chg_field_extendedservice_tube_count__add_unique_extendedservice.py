...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtendedService.tube_count'
        db.alter_column('service_extendedservice', 'tube_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Adding unique constraint on 'ExtendedService', fields ['state', 'base_service']
        db.create_unique('service_extendedservice', ['state_id', 'base_service_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ExtendedService', fields ['state', 'base_service']
        db.delete_unique('service_extendedservice', ['state_id', 'base_service_id'])

        # Changing field 'ExtendedService.tube_count'
        db.alter_column('service_extendedservice', 'tube_count', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 10, 13, 19, 33, 277384)'})
        },
        'service.baseservice': {
