...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabServiceGroup.numerator'
        db.add_column('service_labservicegroup', 'numerator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['numeration.Numerator'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabServiceGroup.numerator'
        db.delete_column('service_labservicegroup', 'numerator_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 35, 30, 578750)'})
        },
        'service.baseservice': {
