...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExtendedService.is_active'
        db.add_column('service_extendedservice', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'BaseService.is_active'
        db.delete_column('service_baseservice', 'is_active')


    def backwards(self, orm):
        
        # Deleting field 'ExtendedService.is_active'
        db.delete_column('service_extendedservice', 'is_active')

        # Adding field 'BaseService.is_active'
        db.add_column('service_baseservice', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 7, 16, 0, 7, 206675)'})
        },
        'service.baseservice': {
