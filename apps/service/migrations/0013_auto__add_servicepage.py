...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('service_servicepage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('service', ['ServicePage'])

        # Adding M2M table for field service_list on 'ServicePage'
        db.create_table('service_servicepage_service_list', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('servicepage', models.ForeignKey(orm['service.servicepage'], null=False)),
            ('baseservice', models.ForeignKey(orm['service.baseservice'], null=False))
        ))
        db.create_unique('service_servicepage_service_list', ['servicepage_id', 'baseservice_id'])


    def backwards(self, orm):
        
        # Deleting model 'ServicePage'
        db.delete_table('service_servicepage')

        # Removing M2M table for field service_list on 'ServicePage'
        db.delete_table('service_servicepage_service_list')
    ...
    models = {
        ...
        'service.servicepage': {
            'Meta': {'object_name': 'ServicePage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'service_list': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['service.BaseService']", 'symmetrical': 'False'})
        },
