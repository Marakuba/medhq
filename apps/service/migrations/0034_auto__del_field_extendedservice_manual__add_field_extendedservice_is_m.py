...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExtendedService.manual'
        db.delete_column('service_extendedservice', 'manual')

        # Adding field 'ExtendedService.is_manual'
        db.add_column('service_extendedservice', 'is_manual', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ExtendedService.manual'
        db.add_column('service_extendedservice', 'manual', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'ExtendedService.is_manual'
        db.delete_column('service_extendedservice', 'is_manual')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 7, 16, 2, 48, 327996)'})
        },
        'service.baseservice': {
