...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExtendedService.code'
        db.add_column('service_extendedservice', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'ExtendedService.base_profile'
        db.add_column('service_extendedservice', 'base_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.AnalysisProfile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExtendedService.code'
        db.delete_column('service_extendedservice', 'code')

        # Deleting field 'ExtendedService.base_profile'
        db.delete_column('service_extendedservice', 'base_profile_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 30, 15, 52, 38, 499931)'})
        },
        'service.baseservice': {
