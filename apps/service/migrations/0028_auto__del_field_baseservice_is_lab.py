...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BaseService.is_lab'
        db.delete_column('service_baseservice', 'is_lab')


    def backwards(self, orm):
        
        # Adding field 'BaseService.is_lab'
        db.add_column('service_baseservice', 'is_lab', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
