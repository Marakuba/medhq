...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ICD10.description'
        db.alter_column('service_icd10', 'description', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'ICD10.description'
        db.alter_column('service_icd10', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 12, 13, 25, 55, 692807)'})
        },
        'service.baseservice': {
