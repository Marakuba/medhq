...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('service_condition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('service', ['Condition'])

        # Adding M2M table for field conditions on 'BaseService'
        db.create_table('service_baseservice_conditions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baseservice', models.ForeignKey(orm['service.baseservice'], null=False)),
            ('condition', models.ForeignKey(orm['service.condition'], null=False))
        ))
        db.create_unique('service_baseservice_conditions', ['baseservice_id', 'condition_id'])


    def backwards(self, orm):
        
        # Deleting model 'Condition'
        db.delete_table('service_condition')

        # Removing M2M table for field conditions on 'BaseService'
        db.delete_table('service_baseservice_conditions')
