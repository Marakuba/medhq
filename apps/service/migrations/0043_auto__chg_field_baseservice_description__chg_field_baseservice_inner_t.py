...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseService.description'
        db.alter_column('service_baseservice', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'BaseService.inner_template'
        db.alter_column('service_baseservice', 'inner_template', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    def backwards(self, orm):

        # Changing field 'BaseService.description'
        db.alter_column('service_baseservice', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'BaseService.inner_template'
        db.alter_column('service_baseservice', 'inner_template', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    models = {
        'auth.group': {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 30, 0, 0)'})
        },
        'service.baseservice': {
