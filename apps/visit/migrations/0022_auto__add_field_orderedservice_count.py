...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.count'
        db.add_column('visit_orderedservice', 'count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedService.count'
        db.delete_column('visit_orderedservice', 'count')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 4, 22, 5, 43, 352436)', 'null': 'True', 'blank': 'True'}),
