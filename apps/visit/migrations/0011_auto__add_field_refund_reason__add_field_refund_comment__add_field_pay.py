...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('visit_refund', 'reason', self.gf('django.db.models.fields.CharField')(default=u'', max_length=1), keep_default=False)

        # Adding field 'Refund.comment'
        db.add_column('visit_refund', 'comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Payment.comment'
        db.add_column('visit_payment', 'comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Refund.reason'
        db.delete_column('visit_refund', 'reason')

        # Deleting field 'Refund.comment'
        db.delete_column('visit_refund', 'comment')

        # Deleting field 'Payment.comment'
        db.delete_column('visit_payment', 'comment')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 9, 22, 5, 48, 318479)'}),
