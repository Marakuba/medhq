...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.modified'
        db.add_column('visit_orderedservice', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 5, 13, 7, 20, 27, 138211), blank=True), keep_default=False)

        # Adding field 'Visit.modified'
        db.add_column('visit_visit', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 5, 13, 7, 20, 41, 450234), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedService.modified'
        db.delete_column('visit_orderedservice', 'modified')

        # Deleting field 'Visit.modified'
        db.delete_column('visit_visit', 'modified')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 13, 7, 20, 10, 601438)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 13, 7, 20, 8, 754514)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 13, 7, 20, 10, 606057)', 'null': 'True', 'blank': 'True'}),
