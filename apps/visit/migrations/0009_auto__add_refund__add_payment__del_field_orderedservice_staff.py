...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field visits on 'Refund'
        db.create_table('visit_refund_visits', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('refund', models.ForeignKey(orm['visit.refund'], null=False)),
            ('visit', models.ForeignKey(orm['visit.visit'], null=False))
        ))
        db.create_unique('visit_refund_visits', ['refund_id', 'visit_id'])

        # Adding M2M table for field ordered_services on 'Refund'
        db.create_table('visit_refund_ordered_services', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('refund', models.ForeignKey(orm['visit.refund'], null=False)),
            ('orderedservice', models.ForeignKey(orm['visit.orderedservice'], null=False))
        ))
        db.create_unique('visit_refund_ordered_services', ['refund_id', 'orderedservice_id'])
        ...
        # Deleting field 'OrderedService.staff'
        db.delete_column('visit_orderedservice', 'staff_id')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field visits on 'Refund'
        db.delete_table('visit_refund_visits')

        # Removing M2M table for field ordered_services on 'Refund'
        db.delete_table('visit_refund_ordered_services')
        ...
        # Adding field 'OrderedService.staff'
        db.add_column('visit_orderedservice', 'staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.Staff'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'visit.refund': {
            ...
            'ordered_services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['visit.OrderedService']", 'null': 'True', 'blank': 'True'}),
            'visits': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['visit.Visit']", 'null': 'True', 'blank': 'True'})
        },
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 9, 21, 41, 11, 416017)'}),
            ...
            'payment_type': ('django.db.models.fields.CharField', [], {'default': "u'\\u043d'", 'max_length': '1'}),
            'services': ('core.fields.SeparatedValuesField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
