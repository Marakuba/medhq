...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.operator'
        db.add_column('visit_orderedservice', 'operator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='operator_in_ordered_service', to=orm['auth.User']), keep_default=False)

        # Adding field 'OrderedService.created'
        db.add_column('visit_orderedservice', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 5, 3, 10, 51, 4, 459257), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedService.operator'
        db.delete_column('visit_orderedservice', 'operator_id')

        # Deleting field 'OrderedService.created'
        db.delete_column('visit_orderedservice', 'created')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 3, 10, 50, 40, 447473)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 3, 10, 50, 39, 710636)'})
        },
        ...
        'visit.refund': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 3, 10, 50, 40, 469778)', 'null': 'True', 'blank': 'True'}),
        ...
        'visit.visit': {
            ...
            'menses_day': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'office': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['state.State']"}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 3, 10, 50, 40, 453183)', 'null': 'True', 'blank': 'True'}),
