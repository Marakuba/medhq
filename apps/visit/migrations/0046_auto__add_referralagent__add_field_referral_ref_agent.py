...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReferralAgent'
        db.create_table('visit_referralagent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_referralagent', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('visit', ['ReferralAgent'])

        # Adding field 'Referral.ref_agent'
        db.add_column('visit_referral', 'ref_agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.ReferralAgent'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ReferralAgent'
        db.delete_table('visit_referralagent')

        # Deleting field 'Referral.ref_agent'
        db.delete_column('visit_referral', 'ref_agent_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 21, 17, 31, 26, 397779)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 21, 17, 31, 26, 348319)'})
        },
        ...
        'visit.referral': {
            ...
            'ref_agent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['visit.ReferralAgent']", 'null': 'True', 'blank': 'True'})
        },
        'visit.referralagent': {
