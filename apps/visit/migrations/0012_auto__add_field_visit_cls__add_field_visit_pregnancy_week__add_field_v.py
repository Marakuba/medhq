...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.cls'
        db.add_column('visit_visit', 'cls', self.gf('django.db.models.fields.CharField')(default=u'\u043f', max_length=1), keep_default=False)

        # Adding field 'Visit.pregnancy_week'
        db.add_column('visit_visit', 'pregnancy_week', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Visit.menses_day'
        db.add_column('visit_visit', 'menses_day', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Visit.menopause'
        db.add_column('visit_visit', 'menopause', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Visit.diagnosis'
        db.add_column('visit_visit', 'diagnosis', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Visit.sampled'
        db.add_column('visit_visit', 'sampled', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.cls'
        db.delete_column('visit_visit', 'cls')

        # Deleting field 'Visit.pregnancy_week'
        db.delete_column('visit_visit', 'pregnancy_week')

        # Deleting field 'Visit.menses_day'
        db.delete_column('visit_visit', 'menses_day')

        # Deleting field 'Visit.menopause'
        db.delete_column('visit_visit', 'menopause')

        # Deleting field 'Visit.diagnosis'
        db.delete_column('visit_visit', 'diagnosis')

        # Deleting field 'Visit.sampled'
        db.delete_column('visit_visit', 'sampled')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 9, 22, 32, 34, 76798)'}),
