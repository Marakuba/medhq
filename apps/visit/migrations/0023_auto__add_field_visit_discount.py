...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.discount'
        db.add_column('visit_visit', 'discount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricelist.Discount'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.discount'
        db.delete_column('visit_visit', 'discount_id')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 8, 15, 43, 10, 85052)', 'null': 'True', 'blank': 'True'}),
