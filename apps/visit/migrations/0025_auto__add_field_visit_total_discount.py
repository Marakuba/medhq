...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.total_discount'
        db.add_column('visit_visit', 'total_discount', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.total_discount'
        db.delete_column('visit_visit', 'total_discount')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 17, 11, 56, 29, 335415)', 'null': 'True', 'blank': 'True'}),
