...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.insurance_policy'
        db.add_column('visit_visit', 'insurance_policy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.InsurancePolicy'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.insurance_policy'
        db.delete_column('visit_visit', 'insurance_policy_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 4, 8, 23, 22, 438352)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 4, 8, 23, 22, 494165)', 'null': 'True', 'blank': 'True'}),
