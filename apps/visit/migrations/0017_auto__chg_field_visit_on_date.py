...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Visit.on_date'
        db.alter_column('visit_visit', 'on_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 14, 8, 46, 25, 563077)', 'null': 'True', 'blank': 'True'}),
