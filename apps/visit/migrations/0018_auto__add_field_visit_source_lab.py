...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.source_lab'
        db.add_column('visit_visit', 'source_lab', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source_lab_in_visit', null=True, to=orm['state.State']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.source_lab'
        db.delete_column('visit_visit', 'source_lab_id')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 14, 22, 14, 37, 50782)', 'null': 'True', 'blank': 'True'}),
