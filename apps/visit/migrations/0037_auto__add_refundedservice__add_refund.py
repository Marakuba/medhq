...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RefundedService'
        db.create_table('visit_refundedservice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Refund'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'])),
            ('execution_place', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['state.State'])),
            ('executed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True, blank=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('total_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('test_form', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
        ...
        db.send_create_signal('visit', ['RefundedService'])

        # Adding model 'Refund'
        db.create_table('visit_refund', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_refund', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('cls', self.gf('django.db.models.fields.CharField')(default=u'\u043f', max_length=1)),
            ('office', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'])),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.Patient'])),
            ('on_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 4, 20, 9, 42, 17, 350818), null=True, blank=True)),
            ('referral', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Referral'], null=True, blank=True)),
            ('pregnancy_week', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('menses_day', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('menopause', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('diagnosis', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('sampled', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('payer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='payer_in_refund', null=True, to=orm['state.State'])),
            ('source_lab', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source_lab_in_refund', null=True, to=orm['state.State'])),
            ('total_price', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True)),
            ('total_paid', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True)),
            ('bill_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('payment_status', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('payment_type', self.gf('django.db.models.fields.CharField')(default=u'\u043d', max_length=1)),
            ('insurance_policy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.InsurancePolicy'], null=True, blank=True)),
            ('discount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricelist.Discount'], null=True, blank=True)),
            ('discount_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('total_discount', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True)),
            ('is_billed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('visit', ['Refund'])


    def backwards(self, orm):
        
        # Deleting model 'RefundedService'
        db.delete_table('visit_refundedservice')

        # Deleting model 'Refund'
        db.delete_table('visit_refund')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 20, 9, 42, 17, 331311)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 20, 9, 42, 16, 878527)'})
        },
        ...
        'visit.payment': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'operator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operator_in_payment'", 'to': "orm['auth.User']"}),
            ...
            'visits': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['visit.Visit']", 'symmetrical': 'False'})
        },
        'visit.referral': {
        ...
        'visit.refund': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 20, 9, 42, 17, 350818)', 'null': 'True', 'blank': 'True'}),
            'operator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operator_in_refund'", 'to': "orm['auth.User']"}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['patient.Patient']"}),
            'payer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'payer_in_refund'", 'null': 'True', 'to': "orm['state.State']"}),
            ...
            'source_lab': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'source_lab_in_refund'", 'null': 'True', 'to': "orm['state.State']"}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
        ...
        'visit.refundedservice': {
            'Meta': {'ordering': "('-order__created',)", 'object_name': 'RefundedService'},
            'count': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'executed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'execution_place': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['state.State']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['visit.Refund']"}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['service.BaseService']"}),
            'staff': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['staff.Position']", 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
        ...
        'visit.visit': {
            ...
            'menses_day': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'office': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['state.State']"}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 20, 9, 42, 17, 339055)', 'null': 'True', 'blank': 'True'}),
