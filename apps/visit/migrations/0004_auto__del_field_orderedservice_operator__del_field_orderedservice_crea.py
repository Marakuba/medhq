...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # We cannot add back in field 'OrderedService.operator'
        raise RuntimeError(
            "Cannot reverse this migration. 'OrderedService.operator' and its values cannot be restored.")

        # We cannot add back in field 'OrderedService.created'
        raise RuntimeError(
            "Cannot reverse this migration. 'OrderedService.created' and its values cannot be restored.")
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 30, 11, 45, 47, 740902)'}),
