...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Referral.ins_state'
        db.delete_column('visit_referral', 'ins_state')

        # Adding field 'OrderedService.sampling'
        db.add_column('visit_orderedservice', 'sampling', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Sampling'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Referral.ins_state'
        db.add_column('visit_referral', 'ins_state', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'OrderedService.sampling'
        db.delete_column('visit_orderedservice', 'sampling_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 5, 18, 33, 37, 113863)'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 5, 18, 33, 36, 643595)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 5, 18, 33, 36, 709504)', 'null': 'True', 'blank': 'True'}),
