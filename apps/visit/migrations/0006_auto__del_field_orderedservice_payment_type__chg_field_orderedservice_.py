...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderedService.payment_type'
        db.delete_column('visit_orderedservice', 'payment_type')

        # Changing field 'OrderedService.status'
        db.alter_column('visit_orderedservice', 'status', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'OrderedService.executed'
        db.alter_column('visit_orderedservice', 'executed', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Adding field 'Visit.payment_type'
        db.add_column('visit_visit', 'payment_type', self.gf('django.db.models.fields.CharField')(default=u'\u043d', max_length=1), keep_default=False)
        ...
        # Changing field 'Visit.total_price'
        db.alter_column('visit_visit', 'total_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Visit.payment_status'
        db.alter_column('visit_visit', 'payment_status', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'Visit.total_paid'
        db.alter_column('visit_visit', 'total_paid', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'Visit.bill_date'
        db.alter_column('visit_visit', 'bill_date', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Adding field 'OrderedService.payment_type'
        db.add_column('visit_orderedservice', 'payment_type', self.gf('django.db.models.fields.CharField')(default=u'\u043d', max_length=1), keep_default=False)

        # Changing field 'OrderedService.status'
        db.alter_column('visit_orderedservice', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'OrderedService.executed'
        db.alter_column('visit_orderedservice', 'executed', self.gf('django.db.models.fields.DateTimeField')())

        # Deleting field 'Visit.payment_type'
        db.delete_column('visit_visit', 'payment_type')

        # Changing field 'Visit.status'
        db.alter_column('visit_visit', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Visit.total_price'
        db.alter_column('visit_visit', 'total_price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Visit.payment_status'
        db.alter_column('visit_visit', 'payment_status', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Visit.total_paid'
        db.alter_column('visit_visit', 'total_paid', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Visit.bill_date'
        db.alter_column('visit_visit', 'bill_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 3, 22, 3, 37, 514758)'}),
