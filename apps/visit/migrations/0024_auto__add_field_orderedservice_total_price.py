...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.total_price'
        db.add_column('visit_orderedservice', 'total_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedService.total_price'
        db.delete_column('visit_orderedservice', 'total_price')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 16, 0, 13, 47, 705928)', 'null': 'True', 'blank': 'True'}),
