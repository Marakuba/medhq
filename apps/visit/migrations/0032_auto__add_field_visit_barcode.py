...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('visit_visit', 'barcode', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['numeration.Barcode'], unique=True, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 31, 14, 14, 20, 183682)'})
        },
        'patient.patient': {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 31, 14, 14, 20, 243455)', 'null': 'True', 'blank': 'True'}),
