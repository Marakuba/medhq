...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('visit_payment')

        # Removing M2M table for field visits on 'Payment'
        db.delete_table('visit_payment_visits')
        ...
        db.create_table('visit_refund', (
            ...
            ('visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Visit'])),
            ('reason', self.gf('django.db.models.fields.CharField')(default=u'\u0441', max_length=1)),
        ))
        db.send_create_signal('visit', ['Refund'])

        # Adding model 'RefundService'
        db.create_table('visit_refundservice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_refund_service', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('refund', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Refund'])),
            ('ordered_service', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['visit.OrderedService'], unique=True)),
        ))
        db.send_create_signal('visit', ['RefundService'])

        # Deleting field 'Visit.staff'
        db.delete_column('visit_visit', 'staff')

        # Deleting field 'Visit.accept_rules'
        db.delete_column('visit_visit', 'accept_rules')

        # Removing M2M table for field services on 'Visit'
        db.delete_table('visit_visit_services')

        # Changing field 'Visit.on_date'
        db.alter_column('visit_visit', 'on_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Visit.status'
        db.alter_column('visit_visit', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Adding model 'Payment'
        db.create_table('visit_payment', (
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('payment_type', self.gf('django.db.models.fields.CharField')(default=u'\u043d', max_length=1)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_payment', to=orm['auth.User'])),
            ('total_paid', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=10, decimal_places=2)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('visit', ['Payment'])

        # Adding M2M table for field visits on 'Payment'
        db.create_table('visit_payment_visits', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('payment', models.ForeignKey(orm['visit.payment'], null=False)),
            ('visit', models.ForeignKey(orm['visit.visit'], null=False))
        ))
        db.create_unique('visit_payment_visits', ['payment_id', 'visit_id'])

        # Deleting model 'Refund'
        db.delete_table('visit_refund')

        # Deleting model 'RefundService'
        db.delete_table('visit_refundservice')

        # Adding field 'Visit.staff'
        db.add_column('visit_visit', 'staff', self.gf('core.fields.SeparatedValuesField')(null=True, blank=True), keep_default=False)

        # Adding field 'Visit.accept_rules'
        db.add_column('visit_visit', 'accept_rules', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding M2M table for field services on 'Visit'
        db.create_table('visit_visit_services', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('visit', models.ForeignKey(orm['visit.visit'], null=False)),
            ('baseservice', models.ForeignKey(orm['service.baseservice'], null=False))
        ))
        db.create_unique('visit_visit_services', ['visit_id', 'baseservice_id'])

        # Changing field 'Visit.on_date'
        db.alter_column('visit_visit', 'on_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Visit.status'
        db.alter_column('visit_visit', 'status', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 13, 15, 24, 49, 683484)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 13, 15, 24, 49, 232720)'})
        },
        ...
        'patient.patient': {
            ...
            'pension_doc': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
        ...
        'visit.refund': {
            ...
            'reason': ('django.db.models.fields.CharField', [], {'default': "u'\\u0441'", 'max_length': '1'}),
            'visit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['visit.Visit']"})
        },
        'visit.refundservice': {
            'Meta': {'object_name': 'RefundService'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'operator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operator_in_refund_service'", 'to': "orm['auth.User']"}),
            'ordered_service': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['visit.OrderedService']", 'unique': 'True'}),
            'refund': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['visit.Refund']"})
        },
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
