...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.office'
        db.add_column('visit_visit', 'office', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['state.State']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.office'
        db.delete_column('visit_visit', 'office_id')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 3, 12, 2, 44, 762529)', 'null': 'True', 'blank': 'True'}),
