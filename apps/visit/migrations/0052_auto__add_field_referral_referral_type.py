...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Referral.referral_type'
        db.add_column('visit_referral', 'referral_type',
                      self.gf('django.db.models.fields.CharField')(default=u'\u0432', max_length=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Referral.referral_type'
        db.delete_column('visit_referral', 'referral_type')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 0, 0)'})
        },
