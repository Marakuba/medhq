...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.execution_place'
        db.add_column('visit_orderedservice', 'execution_place', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['state.State']), keep_default=False)

        # Adding field 'Visit.total_price'
        db.add_column('visit_visit', 'total_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Visit.total_paid'
        db.add_column('visit_visit', 'total_paid', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Visit.bill_date'
        db.add_column('visit_visit', 'bill_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 12, 9, 15, 34, 692651)), keep_default=False)

        # Adding field 'Visit.payment_status'
        db.add_column('visit_visit', 'payment_status', self.gf('django.db.models.fields.CharField')(default=u'п', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedService.execution_place'
        db.delete_column('visit_orderedservice', 'execution_place_id')

        # Deleting field 'Visit.total_price'
        db.delete_column('visit_visit', 'total_price')

        # Deleting field 'Visit.total_paid'
        db.delete_column('visit_visit', 'total_paid')

        # Deleting field 'Visit.bill_date'
        db.delete_column('visit_visit', 'bill_date')

        # Deleting field 'Visit.payment_status'
        db.delete_column('visit_visit', 'payment_status')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 12, 9, 14, 43, 902957)'}),
