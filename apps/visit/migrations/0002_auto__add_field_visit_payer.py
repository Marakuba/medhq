...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.payer'
        db.add_column('visit_visit', 'payer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.payer'
        db.delete_column('visit_visit', 'payer_id')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 11, 9, 49, 37, 90305)'}),
