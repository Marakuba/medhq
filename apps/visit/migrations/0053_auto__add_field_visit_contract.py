...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visit.contract'
        db.add_column('visit_visit', 'contract',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.Contract'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Visit.contract'
        db.delete_column('visit_visit', 'contract_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 24, 0, 0)'})
        },
