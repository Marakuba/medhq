...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('visit_orderedservice', 'staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 17, 22, 32, 44, 287962)', 'null': 'True', 'blank': 'True'}),
