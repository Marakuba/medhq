...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.assigment'
        db.add_column('visit_orderedservice', 'assigment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scheduler.Preorder'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedService.assigment'
        db.delete_column('visit_orderedservice', 'assigment_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 12, 16, 44, 373150)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 12, 16, 44, 311915)'})
        },
