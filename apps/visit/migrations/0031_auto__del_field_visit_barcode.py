...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 31, 14, 14, 0, 278486)'})
        },
        'patient.patient': {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 31, 14, 14, 0, 337150)', 'null': 'True', 'blank': 'True'}),
