...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.sample'
        db.add_column('visit_orderedservice', 'sample', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='sample', unique=True, null=True, to=orm['lab.Sampling']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedService.sample'
        db.delete_column('visit_orderedservice', 'sample_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 18, 9, 10, 9, 121164)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 18, 9, 10, 8, 922500)'})
        },
