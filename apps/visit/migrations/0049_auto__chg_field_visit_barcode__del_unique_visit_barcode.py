...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Visit', fields ['barcode']
        db.delete_unique('visit_visit', ['barcode_id'])

        # Changing field 'Visit.barcode'
        db.alter_column('visit_visit', 'barcode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['numeration.Barcode'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Visit.barcode'
        db.alter_column('visit_visit', 'barcode_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['numeration.Barcode'], unique=True, null=True))

        # Adding unique constraint on 'Visit', fields ['barcode']
        db.create_unique('visit_visit', ['barcode_id'])
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 11, 3, 38, 153915)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 11, 3, 37, 923763)'})
        },
