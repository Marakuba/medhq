...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('visit_visit', 'barcode')


    def backwards(self, orm):
        
        # Adding field 'Visit.barcode'
        db.add_column('visit_visit', 'barcode', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 54, 27, 980869)'})
        },
        'patient.patient': {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 54, 28, 24752)', 'null': 'True', 'blank': 'True'}),
