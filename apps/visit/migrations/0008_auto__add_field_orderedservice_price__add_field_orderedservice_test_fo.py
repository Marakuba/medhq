...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedService.price'
        db.add_column('visit_orderedservice', 'price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'OrderedService.test_form'
        db.add_column('visit_orderedservice', 'test_form', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'OrderedService.test_form'
        db.delete_column('visit_orderedservice', 'test_form')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 9, 13, 25, 48, 348147)'}),
