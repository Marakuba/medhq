...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('visit_referral', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_referral', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('visit', ['Referral'])

        # Adding field 'Visit.referral'
        db.add_column('visit_visit', 'referral', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Referral'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Referral'
        db.delete_table('visit_referral')

        # Deleting field 'Visit.referral'
        db.delete_column('visit_visit', 'referral_id')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 9, 22, 51, 11, 613603)'}),
