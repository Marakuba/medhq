...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.barcode'
        db.add_column('visit_visit', 'barcode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['numeration.Barcode'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visit.barcode'
        db.delete_column('visit_visit', 'barcode_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 59, 27, 832891)'})
        },
        'patient.patient': {
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 59, 27, 881439)', 'null': 'True', 'blank': 'True'}),
