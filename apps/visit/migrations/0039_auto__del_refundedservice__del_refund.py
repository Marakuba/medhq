...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('visit_refund', (
            ...
            ('on_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 3, 10, 50, 40, 469778), null=True, blank=True)),
            ...
            ('source_lab', self.gf('django.db.models.fields.related.ForeignKey')(related_name='source_lab_in_refund', null=True, to=orm['state.State'], blank=True)),
            ...
            ('payer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payer_in_refund', null=True, to=orm['state.State'], blank=True)),
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 12, 15, 32, 39, 949293)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 12, 15, 32, 37, 532415)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 12, 15, 32, 39, 953733)', 'null': 'True', 'blank': 'True'}),
