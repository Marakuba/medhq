!(function(){
    ...
    App.patient.CardVisitGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    //                              Ext.getCmp('vg-change-btn').enable();
            ...
            App.patient.CardVisitGrid.superclass.initComponent.apply(this, arguments);
    ...
    Ext.reg('cardvisitgrid', App.patient.CardVisitGrid);


    if(!window['PatientCard']){
        window['PatientCard'] = [];
    }
    window.PatientCard.push(['cardvisitgrid', {}, 0]);
