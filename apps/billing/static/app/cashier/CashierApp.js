...
App.cashier.CashierApp = Ext.extend(Ext.Panel, {
    ...
    initComponent: function(){
        ...
        App.cashier.CashierApp.superclass.initComponent.apply(this, arguments);
    },
...
Ext.reg('cashierapp', App.cashier.CashierApp);


App.webapp.actions.add('cashierapp', new Ext.Action({
    text: 'Кассир',
    scale: 'medium',
    handler: function(){
        WebApp.fireEvent('launchapp','cashierapp');
    }
}));