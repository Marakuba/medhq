...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.print_check'
        db.add_column('billing_payment', 'print_check', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.print_check'
        db.delete_column('billing_payment', 'print_check')
