...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.direction'
        db.add_column('billing_payment', 'direction', self.gf('django.db.models.fields.CharField')(default=True, max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.direction'
        db.delete_column('billing_payment', 'direction')
    ...
    models = {
        ...
        'billing.payment': {
            'Meta': {'ordering': "('-doc_date',)", 'object_name': 'Payment'},
