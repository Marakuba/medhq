...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.office'
        db.add_column('billing_payment', 'office', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.office'
        db.delete_column('billing_payment', 'office_id')
