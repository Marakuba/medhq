...
class Payment(models.Model):
    ...
    direction = models.CharField(u'Направление оплаты', max_length=10, choices=PAYMENT_TYPES)
    payment_type = models.CharField(u'Вид оплаты', max_length=1, choices=PAYMENT_DIRECTION, blank=True, null=True)
