...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('taskmanager_task', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['taskmanager.Task'])),
    ...
    models = {
        ...
        'taskmanager.task': {
            ...
            'operator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operator_in_task'", 'to': "orm['auth.User']"}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['taskmanager.Task']"}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['taskmanager.TaskType']"}),
            'watcher': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'watcher'", 'null': 'True', 'to': "orm['auth.User']"})
        },
