...
class DelayedTask(make_operator_object('delayed_task')):
    """
    """
    id_task = models.CharField(u'ID задачи', max_length=36)
    attempts = models.PositiveIntegerField(u'Количество попыток', default=1)
    ...
    type = models.CharField(u'Статус', max_length=10, choices=DELAYED_TASK_TYPES)
