...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContractType.template'
        db.add_column('patient_contracttype', 'template',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ContractType.template'
        db.delete_column('patient_contracttype', 'template')
