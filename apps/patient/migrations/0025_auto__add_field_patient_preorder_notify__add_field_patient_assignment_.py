...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.preorder_notify'
        db.add_column('patient_patient', 'preorder_notify',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Patient.assignment_notify'
        db.add_column('patient_patient', 'assignment_notify',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Patient.preorder_notify'
        db.delete_column('patient_patient', 'preorder_notify')

        # Deleting field 'Patient.assignment_notify'
        db.delete_column('patient_patient', 'assignment_notify')
