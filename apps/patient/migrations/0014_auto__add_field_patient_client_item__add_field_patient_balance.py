...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.client_item'
        db.add_column('patient_patient', 'client_item', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='client', unique=True, null=True, to=orm['interlayer.ClientItem']), keep_default=False)

        # Adding field 'Patient.balance'
        db.add_column('patient_patient', 'balance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.client_item'
        db.delete_column('patient_patient', 'client_item_id')

        # Deleting field 'Patient.balance'
        db.delete_column('patient_patient', 'balance')
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 25, 12, 39, 9, 788953)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
