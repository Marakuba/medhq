...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.modified'
        db.add_column('patient_patient', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 12, 27, 19, 51, 32, 826219), blank=True), keep_default=False)

        # Adding field 'Patient.state'
        db.add_column('patient_patient', 'state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.modified'
        db.delete_column('patient_patient', 'modified')

        # Deleting field 'Patient.state'
        db.delete_column('patient_patient', 'state_id')
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 26, 19, 51, 12, 623300)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
