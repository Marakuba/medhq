...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InsurancePolicy'
        db.create_table('patient_insurancepolicy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_insurance_policy', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.Patient'])),
            ('insurance_state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'])),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('patient', ['InsurancePolicy'])


    def backwards(self, orm):
        
        # Deleting model 'InsurancePolicy'
        db.delete_table('patient_insurancepolicy')
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 2, 21, 2, 6, 789591)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
