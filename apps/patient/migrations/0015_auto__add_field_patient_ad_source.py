...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.ad_source'
        db.add_column('patient_patient', 'ad_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.AdSource'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.ad_source'
        db.delete_column('patient_patient', 'ad_source_id')
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 9, 11, 13, 5, 246066)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
