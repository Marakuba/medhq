...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agreement.accepted'
        db.alter_column('patient_agreement', 'accepted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Agreement.accepted'
        db.alter_column('patient_agreement', 'accepted', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 28, 15, 39, 15, 257797)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['patient.Patient']"})
        },
