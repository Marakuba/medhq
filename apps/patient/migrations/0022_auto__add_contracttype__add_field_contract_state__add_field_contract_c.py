...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('patient_contracttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('validity', self.gf('django.db.models.fields.IntegerField')(default=30)),
            ('type', self.gf('django.db.models.fields.CharField')(default=u'\u0433', max_length=1)),
        ))
        db.send_create_signal('patient', ['ContractType'])

        # Adding field 'Contract.state'
        db.add_column('patient_contract', 'state',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contract.contract_type'
        db.add_column('patient_contract', 'contract_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.ContractType'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Contract.created'
        db.alter_column('patient_contract', 'created', self.gf('django.db.models.fields.DateField')())
    def backwards(self, orm):
        # Deleting model 'ContractType'
        db.delete_table('patient_contracttype')

        # Deleting field 'Contract.state'
        db.delete_column('patient_contract', 'state_id')

        # Deleting field 'Contract.contract_type'
        db.delete_column('patient_contract', 'contract_type_id')


        # Changing field 'Contract.created'
        db.alter_column('patient_contract', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    models = {
        'auth.group': {
        ...
        'patient.agreement': {
            ...
            'accepted': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'patient.contracttype': {
            ...
            'validity': ('django.db.models.fields.IntegerField', [], {'default': '30'})
        },
