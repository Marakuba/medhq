...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('patient_patient', 'email', self.gf('django.db.models.fields.EmailField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.email'
        db.delete_column('patient_patient', 'email')
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 9, 22, 16, 46, 808941)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
