...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Patient.insurance_state'
        db.delete_column('patient_patient', 'insurance_state_id')

        # Deleting field 'Patient.pension_doc'
        db.delete_column('patient_patient', 'pension_doc')

        # Deleting field 'Patient.insurance_doc'
        db.delete_column('patient_patient', 'insurance_doc')

        # Adding field 'Patient.doc'
        db.add_column('patient_patient', 'doc', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Patient.insurance_state'
        db.add_column('patient_patient', 'insurance_state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'], null=True, blank=True), keep_default=False)

        # Adding field 'Patient.pension_doc'
        db.add_column('patient_patient', 'pension_doc', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Patient.insurance_doc'
        db.add_column('patient_patient', 'insurance_doc', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Deleting field 'Patient.doc'
        db.delete_column('patient_patient', 'doc')
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 12, 20, 2, 16, 136387)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
