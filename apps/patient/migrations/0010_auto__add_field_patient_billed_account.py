...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('patient_patient', 'billed_account', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2), keep_default=False)
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 11, 13, 47, 6, 88667)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
