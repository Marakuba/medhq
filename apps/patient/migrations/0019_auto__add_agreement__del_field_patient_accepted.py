...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('patient_agreement', (
        ...
        db.send_create_signal('patient', ['Agreement'])

        # Deleting field 'Patient.accepted'
        db.delete_column('patient_patient', 'accepted')


    def backwards(self, orm):
        
        # Deleting model 'Agreement'
        db.delete_table('patient_agreement')

        # Adding field 'Patient.accepted'
        db.add_column('patient_patient', 'accepted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'patient.contract': {
            ...
            'expire': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 28, 14, 18, 41, 387172)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['patient.Patient']"})
        },
