...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Standart.age_to'
        db.delete_column('medstandart_standart', 'age_to')

        # Deleting field 'Standart.age_from'
        db.delete_column('medstandart_standart', 'age_from')

        # Adding field 'AgeCategory.age_from'
        db.add_column('medstandart_agecategory', 'age_from',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AgeCategory.age_to'
        db.add_column('medstandart_agecategory', 'age_to',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=250),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Standart.age_to'
        db.add_column('medstandart_standart', 'age_to',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=250),
                      keep_default=False)

        # Adding field 'Standart.age_from'
        db.add_column('medstandart_standart', 'age_from',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'AgeCategory.age_from'
        db.delete_column('medstandart_agecategory', 'age_from')

        # Deleting field 'AgeCategory.age_to'
        db.delete_column('medstandart_agecategory', 'age_to')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 6, 0, 0)'})
        },
        'service.baseservice': {
