...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvoiceItem.preorder'
        db.alter_column('accounting_invoiceitem', 'preorder_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.Preorder'], unique=True, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InvoiceItem.preorder'
        raise RuntimeError("Cannot reverse this migration. 'InvoiceItem.preorder' and its values cannot be restored.")
    ...
    models = {
        ...
        'accounting.invoiceitem': {
            ...
            'preorder': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['scheduler.Preorder']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 31, 15, 59, 41, 77647)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 31, 15, 59, 41, 57949)'})
        },
