...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounting_contract', (
            ...
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_acc_contract', to=orm['auth.User'])),
            ...
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_branch', to=orm['state.State'])),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_state', to=orm['state.State'])),
        ...
        db.create_table('accounting_invoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_acc_invoice', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.create_table('accounting_invoiceitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_acc_invoice_item', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('execution_place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'])),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            ('total_price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('preorder', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.Preorder'], unique=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('accounting', ['InvoiceItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounting_invoiceitem')


    models = {
        'accounting.contract': {
            'Meta': {'object_name': 'Contract'},
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contract_branch'", 'to': "orm['state.State']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'on_date': ('django.db.models.fields.DateField', [], {}),
            'operator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operator_in_acc_contract'", 'to': "orm['auth.User']"}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contract_state'", 'to': "orm['state.State']"})
        },
        'accounting.invoice': {
            ...
            'number': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'on_date': ('django.db.models.fields.DateField', [], {}),
            'operator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operator_in_acc_invoice'", 'to': "orm['auth.User']"}),
        ...
        'accounting.invoiceitem': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'operator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'operator_in_acc_invoice_item'", 'to': "orm['auth.User']"}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['patient.Patient']"}),
            'preorder': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['scheduler.Preorder']", 'unique': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 31, 10, 27, 42, 632534)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 31, 10, 27, 42, 613422)'})
        },
