...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Viewport.is_active'
        db.add_column('webapp_viewport', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Viewport.is_active'
        db.delete_column('webapp_viewport', 'is_active')
