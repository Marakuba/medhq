...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Viewport.template'
        db.add_column('webapp_viewport', 'template', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Viewport.template'
        db.delete_column('webapp_viewport', 'template')
