...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ViewportApp.config'
        db.add_column('webapp_viewportapp', 'config', self.gf('jsonfield.fields.JSONField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ViewportApp.config'
        db.delete_column('webapp_viewportapp', 'config')
    ...
    models = {
        ...
        'webapp.viewportapp': {
            'Meta': {'ordering': "('order',)", 'object_name': 'ViewportApp'},
