...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Viewport.order'
        db.add_column('webapp_viewport', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Viewport.order'
        db.delete_column('webapp_viewport', 'order')
