...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PriceType', fields ['priority']
        db.delete_unique('pricelist_pricetype', ['priority'])

    def backwards(self, orm):
        # Adding unique constraint on 'PriceType', fields ['priority']
        db.create_unique('pricelist_pricetype', ['priority'])
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 17, 0, 0)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 17, 0, 0)'}),
