...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.payment_type'
        db.add_column('pricelist_price', 'payment_type', self.gf('django.db.models.fields.CharField')(default=u'\u043d', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Price.payment_type'
        db.delete_column('pricelist_price', 'payment_type')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 7, 51, 31, 665059)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 6)'}),
