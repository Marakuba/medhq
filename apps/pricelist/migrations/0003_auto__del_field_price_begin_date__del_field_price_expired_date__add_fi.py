...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.on_date'
        db.add_column('pricelist_price', 'on_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 11)), keep_default=False)

        # Deleting field 'PriceType.only_for_state'
        db.delete_column('pricelist_pricetype', 'only_for_state_id')

        # Adding field 'PriceType.slug'
        db.add_column('pricelist_pricetype', 'slug', self.gf('django.db.models.fields.SlugField')(default=u'', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'Price.begin_date'
        raise RuntimeError(
            "Cannot reverse this migration. 'Price.begin_date' and its values cannot be restored.")
        ...
        # Deleting field 'Price.on_date'
        db.delete_column('pricelist_price', 'on_date')

        # Adding field 'PriceType.only_for_state'
        db.add_column('pricelist_pricetype', 'only_for_state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'], null=True), keep_default=False)

        # Deleting field 'PriceType.slug'
        db.delete_column('pricelist_pricetype', 'slug')
