...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PriceRule'
        db.create_table('pricelist_pricerule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('price_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricelist.PriceType'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(default=u'', max_length=50, null=True, blank=True)),
            ('hour', self.gf('django.db.models.fields.CharField')(default=u'', max_length=150, null=True, blank=True)),
            ('week_day', self.gf('django.db.models.fields.CharField')(default=u'', max_length=150, null=True, blank=True)),
            ('month_day', self.gf('django.db.models.fields.CharField')(default=u'', max_length=150, null=True, blank=True)),
            ('month', self.gf('django.db.models.fields.CharField')(default=u'', max_length=150, null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('priority', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, unique=True)),
        ))
        db.send_create_signal('pricelist', ['PriceRule'])

    def backwards(self, orm):
        # Deleting model 'PriceRule'
        db.delete_table('pricelist_pricerule')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'}),
        ...
        'pricelist.pricerule': {
            'Meta': {'ordering': "('priority', 'active')", 'object_name': 'PriceRule'},
            ...
            'price_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricelist.PriceType']"}),
