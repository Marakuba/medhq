...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Price.type'
        db.alter_column('pricelist_price', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricelist.PriceType'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Price.type'
        raise RuntimeError("Cannot reverse this migration. 'Price.type' and its values cannot be restored.")
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 6, 9, 19, 59, 788115)'})
        },
        'pricelist.discount': {
