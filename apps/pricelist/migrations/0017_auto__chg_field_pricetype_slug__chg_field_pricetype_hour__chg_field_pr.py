...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PriceType.slug'
        db.alter_column('pricelist_pricetype', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PriceType.slug'
        db.alter_column('pricelist_pricetype', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 27, 0, 0)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 27, 0, 0)'}),
