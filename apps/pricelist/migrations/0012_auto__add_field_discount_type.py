...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pricelist_discount', 'type', self.gf('django.db.models.fields.CharField')(default=u'gen', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Discount.type'
        db.delete_column('pricelist_discount', 'type')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 12, 20, 26, 46, 773668)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 6, 12, 20, 26, 46, 973923)'}),
