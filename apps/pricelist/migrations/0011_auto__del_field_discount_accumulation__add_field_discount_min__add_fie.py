...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Discount.accumulation'
        db.delete_column('pricelist_discount', 'accumulation')

        # Adding field 'Discount.min'
        db.add_column('pricelist_discount', 'min', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Discount.max'
        db.add_column('pricelist_discount', 'max', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Discount.accumulation'
        db.add_column('pricelist_discount', 'accumulation', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Discount.min'
        db.delete_column('pricelist_discount', 'min')

        # Deleting field 'Discount.max'
        db.delete_column('pricelist_discount', 'max')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 12, 13, 45, 7, 516797)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 6, 12, 13, 45, 7, 713974)'}),
