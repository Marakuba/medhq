...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for p in orm.PriceType.objects.all():
            orm.PriceRule.objects.create(price_type=p, active=p.active,
                                        slug=p.slug, hour=p.hour,
                                        week_day=p.week_day, month_day=p.month_day,
                                        month=p.month, priority=p.priority)
