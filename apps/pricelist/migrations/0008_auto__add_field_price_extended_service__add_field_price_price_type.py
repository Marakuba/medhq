...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.extended_service'
        db.add_column('pricelist_price', 'extended_service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ExtendedService'], null=True, blank=True), keep_default=False)

        # Adding field 'Price.price_type'
        db.add_column('pricelist_price', 'price_type', self.gf('django.db.models.fields.CharField')(default='r', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Price.extended_service'
        db.delete_column('pricelist_price', 'extended_service_id')

        # Deleting field 'Price.price_type'
        db.delete_column('pricelist_price', 'price_type')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 5, 18, 33, 59, 909001)'})
        },
        'pricelist.discount': {
        ...
        'service.extendedservice': {
            'Meta': {'object_name': 'ExtendedService'},
            'base_service': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['service.BaseService']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
