...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pricelist_price', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Price.service'
        raise RuntimeError("Cannot reverse this migration. 'Price.service' and its values cannot be restored.")
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 6, 8, 57, 20, 756711)'})
        },
        'pricelist.discount': {
