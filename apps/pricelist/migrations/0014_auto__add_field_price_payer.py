...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.payer'
        db.add_column('pricelist_price', 'payer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='payer_in_pricelist', null=True, to=orm['state.State']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Price.payer'
        db.delete_column('pricelist_price', 'payer_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 16, 4, 36, 197100)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 3, 21)'}),
