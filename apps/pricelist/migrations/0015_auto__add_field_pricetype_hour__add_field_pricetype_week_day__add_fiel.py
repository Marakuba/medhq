...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PriceType.hour'
        db.add_column('pricelist_pricetype', 'hour',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PriceType.week_day'
        db.add_column('pricelist_pricetype', 'week_day',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PriceType.month_day'
        db.add_column('pricelist_pricetype', 'month_day',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PriceType.month'
        db.add_column('pricelist_pricetype', 'month',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PriceType.active'
        db.add_column('pricelist_pricetype', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PriceType.priority'
        db.add_column('pricelist_pricetype', 'priority',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PriceType.hour'
        db.delete_column('pricelist_pricetype', 'hour')

        # Deleting field 'PriceType.week_day'
        db.delete_column('pricelist_pricetype', 'week_day')

        # Deleting field 'PriceType.month_day'
        db.delete_column('pricelist_pricetype', 'month_day')

        # Deleting field 'PriceType.month'
        db.delete_column('pricelist_pricetype', 'month')

        # Deleting field 'PriceType.active'
        db.delete_column('pricelist_pricetype', 'active')

        # Deleting field 'PriceType.priority'
        db.delete_column('pricelist_pricetype', 'priority')
    ...
    models = {
        ...
        'pricelist.pricetype': {
            ...
            'hour': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'month': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'month_day': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u''", 'max_length': '50'}),
            'week_day': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'})
        },
        'service.baseservice': {
