...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Price.service'
        db.delete_column('pricelist_price', 'service_id')

    def backwards(self, orm):
        # Adding field 'Price.service'
        db.add_column('pricelist_price', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 0, 0)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 7, 0, 0)'}),
            'payer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'payer_in_pricelist'", 'null': 'True', 'to': "orm['state.State']"}),
            'payment_type': ('django.db.models.fields.CharField', [], {'default': "u'\\u043d'", 'max_length': '1', 'blank': 'True'}),
