...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PriceType.hour'
        db.alter_column('pricelist_pricetype', 'hour', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'PriceType.month_day'
        db.alter_column('pricelist_pricetype', 'month_day', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'PriceType.month'
        db.alter_column('pricelist_pricetype', 'month', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'PriceType.week_day'
        db.alter_column('pricelist_pricetype', 'week_day', self.gf('django.db.models.fields.CharField')(max_length=150))
    def backwards(self, orm):

        # Changing field 'PriceType.hour'
        db.alter_column('pricelist_pricetype', 'hour', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PriceType.month_day'
        db.alter_column('pricelist_pricetype', 'month_day', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PriceType.month'
        db.alter_column('pricelist_pricetype', 'month', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PriceType.week_day'
        db.alter_column('pricelist_pricetype', 'week_day', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
    models = {
        'auth.group': {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 26, 0, 0)'})
        },
        'pricelist.discount': {
        ...
        'pricelist.price': {
            ...
            'extended_service': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['service.ExtendedService']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 26, 0, 0)'}),
            'payer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'payer_in_pricelist'", 'null': 'True', 'to': "orm['state.State']"}),
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricelist.PriceType']", 'null': 'True', 'blank': 'True'}),
            'value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'})
        },
        'pricelist.pricetype': {
            'Meta': {'object_name': 'PriceType'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'hour': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '150'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'month': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '150'}),
            'month_day': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '150'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "u''", 'max_length': '50'}),
            'week_day': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '150'})
        },
        'service.baseservice': {
