...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TransactionItem.message'
        db.add_column('remoting_transactionitem', 'message', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TransactionItem.message'
        db.delete_column('remoting_transactionitem', 'message')
