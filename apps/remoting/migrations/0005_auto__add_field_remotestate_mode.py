...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RemoteState.mode'
        db.add_column('remoting_remotestate', 'mode', self.gf('django.db.models.fields.CharField')(default=u'a', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RemoteState.mode'
        db.delete_column('remoting_remotestate', 'mode')
