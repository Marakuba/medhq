...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RemoteState.user'
        db.add_column('remoting_remotestate', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RemoteState.user'
        db.delete_column('remoting_remotestate', 'user_id')
