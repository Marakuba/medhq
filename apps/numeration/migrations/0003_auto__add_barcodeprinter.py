...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BarcodePrinter'
        db.create_table('numeration_barcodeprinter', (
            ...
            ('port', self.gf('django.db.models.fields.IntegerField')(default=8888)),
        ))
        db.send_create_signal('numeration', ['BarcodePrinter'])


    def backwards(self, orm):
        
        # Deleting model 'BarcodePrinter'
        db.delete_table('numeration_barcodeprinter')
    ...
    models = {
        ...
        'numeration.barcodeprinter': {
            'Meta': {'object_name': 'BarcodePrinter'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'port': ('django.db.models.fields.IntegerField', [], {'default': '8888'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 2, 13, 14, 7, 554329)'})
        },
