...
App.results.ResultApp = Ext.extend(Ext.Panel, {
    initComponent:function(){
        ...
        App.results.ResultApp.superclass.initComponent.apply(this, arguments);
...
Ext.reg('resultapp', App.results.ResultApp);

App.webapp.actions.add('resultapp', new Ext.Action({
    text: 'Результаты',
    scale: 'medium',
    handler: function(){
        WebApp.fireEvent('launchapp','resultapp');
    }
}));