                ...
                render: function(p){
                    p.body.on({
                        'click': function(e, t){ // if they tab + enter a link, need to do it old fashioned way
                            ...
                            switch (type) {
                                case 'search':
                                    WebApp.gsf.imitate(val);
                                    WebApp.centralPanel.mainPanel.setActiveTab(0);
                                    break;
                                default:
                                    break;
                            }
...
App.webapp.actions.add('labregisterapp', new Ext.Action({
    text: 'Реестр тестов',
    scale: 'medium',
    handler: function(){
        WebApp.fireEvent('launchapp','labregisterapp');
    }
}));