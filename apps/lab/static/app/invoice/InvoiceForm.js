...
//					layout:'form',
		...
		this.on('afterrender', function(){
			if(this.record) {
				...
				console.info(App.utils.getApiUrl('state', 'ownstate',WebApp.active_state_id));
				this.getForm().findField('office').setValue(App.utils.getApiUrl('state', 'ownstate',WebApp.active_state_id));
			}
		},this);
