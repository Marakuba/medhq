...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LabService'
        db.create_table('lab_labservice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base_service', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['service.BaseService'], unique=True)),
            ('is_manual', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('lab', ['LabService'])


    def backwards(self, orm):
        
        # Deleting model 'LabService'
        db.delete_table('lab_labservice')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 26, 16, 1, 20, 14867)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 26, 16, 1, 19, 986051)'})
        },
