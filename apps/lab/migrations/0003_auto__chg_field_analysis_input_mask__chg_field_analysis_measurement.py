...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Analysis.input_mask'
        db.alter_column('lab_analysis', 'input_mask_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.InputMask'], null=True))

        # Changing field 'Analysis.measurement'
        db.alter_column('lab_analysis', 'measurement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Measurement'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Analysis.input_mask'
        db.alter_column('lab_analysis', 'input_mask_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.InputMask']))

        # Changing field 'Analysis.measurement'
        db.alter_column('lab_analysis', 'measurement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Measurement']))
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 29, 23, 49, 0, 843210)'}),
