...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentAssay.name'
        db.add_column('lab_equipmentassay', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'EquipmentAssay.code'
        db.add_column('lab_equipmentassay', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Deleting field 'Equipment.address'
        db.delete_column('lab_equipment', 'address')

        # Adding field 'Equipment.serial_number'
        db.add_column('lab_equipment', 'serial_number', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Deleting field 'EquipmentResult.equipment'
        db.delete_column('lab_equipmentresult', 'equipment_id')

        # Deleting field 'EquipmentResult.assay'
        db.delete_column('lab_equipmentresult', 'assay')

        # Deleting field 'EquipmentResult.measurement'
        db.delete_column('lab_equipmentresult', 'measurement')

        # Deleting field 'EquipmentResult.order'
        db.delete_column('lab_equipmentresult', 'order')

        # Adding field 'EquipmentResult.equipment_task'
        db.add_column('lab_equipmentresult', 'equipment_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.EquipmentTask'], null=True, blank=True), keep_default=False)

        # Adding field 'EquipmentResult.eq_serial_number'
        db.add_column('lab_equipmentresult', 'eq_serial_number', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'EquipmentResult.specimen'
        db.add_column('lab_equipmentresult', 'specimen', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'EquipmentResult.assay_name'
        db.add_column('lab_equipmentresult', 'assay_name', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'EquipmentResult.assay_code'
        db.add_column('lab_equipmentresult', 'assay_code', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'EquipmentResult.assay_protocol'
        db.add_column('lab_equipmentresult', 'assay_protocol', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'EquipmentResult.result_type'
        db.add_column('lab_equipmentresult', 'result_type', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)

        # Adding field 'EquipmentResult.result_status'
        db.add_column('lab_equipmentresult', 'result_status', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)

        # Adding field 'EquipmentResult.abnormal_flags'
        db.add_column('lab_equipmentresult', 'abnormal_flags', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'EquipmentResult.units'
        db.add_column('lab_equipmentresult', 'units', self.gf('django.db.models.fields.CharField')(default='', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EquipmentAssay.name'
        db.delete_column('lab_equipmentassay', 'name')

        # Deleting field 'EquipmentAssay.code'
        db.delete_column('lab_equipmentassay', 'code')

        # User chose to not deal with backwards NULL issues for 'Equipment.address'
        raise RuntimeError("Cannot reverse this migration. 'Equipment.address' and its values cannot be restored.")

        # Deleting field 'Equipment.serial_number'
        db.delete_column('lab_equipment', 'serial_number')

        # User chose to not deal with backwards NULL issues for 'EquipmentResult.equipment'
        raise RuntimeError("Cannot reverse this migration. 'EquipmentResult.equipment' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EquipmentResult.assay'
        raise RuntimeError("Cannot reverse this migration. 'EquipmentResult.assay' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EquipmentResult.measurement'
        raise RuntimeError("Cannot reverse this migration. 'EquipmentResult.measurement' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EquipmentResult.order'
        raise RuntimeError("Cannot reverse this migration. 'EquipmentResult.order' and its values cannot be restored.")

        # Deleting field 'EquipmentResult.equipment_task'
        db.delete_column('lab_equipmentresult', 'equipment_task_id')

        # Deleting field 'EquipmentResult.eq_serial_number'
        db.delete_column('lab_equipmentresult', 'eq_serial_number')

        # Deleting field 'EquipmentResult.specimen'
        db.delete_column('lab_equipmentresult', 'specimen')

        # Deleting field 'EquipmentResult.assay_name'
        db.delete_column('lab_equipmentresult', 'assay_name')

        # Deleting field 'EquipmentResult.assay_code'
        db.delete_column('lab_equipmentresult', 'assay_code')

        # Deleting field 'EquipmentResult.assay_protocol'
        db.delete_column('lab_equipmentresult', 'assay_protocol')

        # Deleting field 'EquipmentResult.result_type'
        db.delete_column('lab_equipmentresult', 'result_type')

        # Deleting field 'EquipmentResult.result_status'
        db.delete_column('lab_equipmentresult', 'result_status')

        # Deleting field 'EquipmentResult.abnormal_flags'
        db.delete_column('lab_equipmentresult', 'abnormal_flags')

        # Deleting field 'EquipmentResult.units'
        db.delete_column('lab_equipmentresult', 'units')
    ...
    models = {
        ...
        'lab.equipmentassay': {
            'Meta': {'object_name': 'EquipmentAssay'},
        ...
        'lab.equipmentresult': {
            ...
            'abnormal_flags': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'assay_code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'assay_name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'assay_protocol': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'lab.equipmenttask': {
            'Meta': {'object_name': 'EquipmentTask'},
        ...
        'lab.result': {
            ...
            'previous_value': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 22, 17, 52, 78771)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 22, 17, 52, 29921)'})
        },
