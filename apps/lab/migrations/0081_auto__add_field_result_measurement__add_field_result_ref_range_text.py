...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.measurement'
        db.add_column('lab_result', 'measurement', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Result.ref_range_text'
        db.add_column('lab_result', 'ref_range_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Result.measurement'
        db.delete_column('lab_result', 'measurement')

        # Deleting field 'Result.ref_range_text'
        db.delete_column('lab_result', 'ref_range_text')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 9, 4, 3, 242018)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 10, 9, 4, 2, 936514)'})
        },
