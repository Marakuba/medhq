...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.input_list'
        db.add_column('lab_result', 'input_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.InputList'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Result.input_list'
        db.delete_column('lab_result', 'input_list_id')
    ...
    models = {
        ...
        'lab.analysis': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imput_list': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lab.InputList']", 'null': 'True', 'blank': 'True'}),
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 8, 11, 5, 13, 954022)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 8, 11, 5, 13, 935246)'}),
