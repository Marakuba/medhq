...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('lab', ['Sampling'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Sampling'
        db.delete_table('lab_sampling')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 17, 7, 45, 19, 586791)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 17, 7, 45, 19, 510719)', 'null': 'True', 'blank': 'True'}),
