...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnalysisProfile'
        db.create_table('lab_analysisprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('lab', ['AnalysisProfile'])

        # Adding field 'Analysis.profile'
        db.add_column('lab_analysis', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.AnalysisProfile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'AnalysisProfile'
        db.delete_table('lab_analysisprofile')

        # Deleting field 'Analysis.profile'
        db.delete_column('lab_analysis', 'profile_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 12, 48, 54, 798031)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 12, 48, 54, 755094)'})
        },
