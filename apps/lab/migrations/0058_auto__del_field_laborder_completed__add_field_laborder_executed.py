...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LabOrder.completed'
        db.delete_column('lab_laborder', 'completed')

        # Adding field 'LabOrder.executed'
        db.add_column('lab_laborder', 'executed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'LabOrder.completed'
        db.add_column('lab_laborder', 'completed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'LabOrder.executed'
        db.delete_column('lab_laborder', 'executed')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 20, 11, 25, 18, 572017)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 20, 11, 25, 18, 542842)'})
        },
