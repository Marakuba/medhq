...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.confirmed'
        db.add_column('lab_laborder', 'confirmed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabOrder.confirmed'
        db.delete_column('lab_laborder', 'confirmed')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'send_status': ('django.db.models.fields.CharField', [], {'default': "u'work'", 'max_length': '10', 'blank': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 23, 12, 41, 9, 700089)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 23, 12, 41, 9, 216405)'})
        },
