...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.is_completed'
        db.add_column('lab_laborder', 'is_completed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'LabOrder.is_printed'
        db.add_column('lab_laborder', 'is_printed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'LabOrder.print_date'
        db.add_column('lab_laborder', 'print_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabOrder.is_completed'
        db.delete_column('lab_laborder', 'is_completed')

        # Deleting field 'LabOrder.is_printed'
        db.delete_column('lab_laborder', 'is_printed')

        # Deleting field 'LabOrder.print_date'
        db.delete_column('lab_laborder', 'print_date')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 29, 9, 27, 34, 20214)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 29, 9, 27, 33, 988272)'}),
