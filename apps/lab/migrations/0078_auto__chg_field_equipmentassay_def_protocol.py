...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EquipmentAssay.def_protocol'
        db.alter_column('lab_equipmentassay', 'def_protocol', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'EquipmentAssay.def_protocol'
        db.alter_column('lab_equipmentassay', 'def_protocol', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'lab.equipmentassay': {
            ...
            'def_protocol': ('django.db.models.fields.TextField', [], {'default': "''"}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 2, 19, 25, 13, 238118)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 2, 19, 25, 13, 121880)'})
        },
