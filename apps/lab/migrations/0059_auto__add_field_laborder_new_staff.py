...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.new_staff'
        db.add_column('lab_laborder', 'new_staff', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='position', null=True, to=orm['staff.Position']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabOrder.new_staff'
        db.delete_column('lab_laborder', 'new_staff_id')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'staff': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'old_staff'", 'null': 'True', 'to': "orm['staff.Staff']"}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 22, 12, 26, 56, 427989)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 22, 12, 26, 56, 399199)'})
        },
