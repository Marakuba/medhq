...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.office'
        db.add_column('lab_invoice', 'office', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='office', to=orm['state.State']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.office'
        db.delete_column('lab_invoice', 'office_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 30, 21, 44, 57, 968332)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 30, 21, 44, 57, 693387)'})
        },
