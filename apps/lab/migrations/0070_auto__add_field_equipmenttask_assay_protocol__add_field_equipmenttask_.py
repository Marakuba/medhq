...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentTask.assay_protocol'
        db.add_column('lab_equipmenttask', 'assay_protocol', self.gf('django.db.models.fields.CharField')(default='UNDILUTED', max_length=20), keep_default=False)

        # Adding field 'EquipmentTask.is_locked'
        db.add_column('lab_equipmenttask', 'is_locked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EquipmentTask.assay_protocol'
        db.delete_column('lab_equipmenttask', 'assay_protocol')

        # Deleting field 'EquipmentTask.is_locked'
        db.delete_column('lab_equipmenttask', 'is_locked')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 28, 15, 37, 0, 523517)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 28, 15, 37, 0, 486289)'})
        },
