...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tube'
        db.create_table('lab_tube', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lab', ['Tube'])

        # Adding field 'Analysis.tube'
        db.add_column('lab_analysis', 'tube', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Tube'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Tube'
        db.delete_table('lab_tube')

        # Deleting field 'Analysis.tube'
        db.delete_column('lab_analysis', 'tube_id')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 22, 16, 40, 19, 308129)'}),
