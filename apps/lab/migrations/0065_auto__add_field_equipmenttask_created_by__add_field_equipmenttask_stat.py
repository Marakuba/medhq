...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentTask.created_by'
        db.add_column('lab_equipmenttask', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'EquipmentTask.status'
        db.add_column('lab_equipmenttask', 'status', self.gf('django.db.models.fields.CharField')(default=u'wait', max_length=5), keep_default=False)

        # Adding field 'EquipmentResult.created'
        db.add_column('lab_equipmentresult', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 9, 24, 8, 40, 39, 612137), blank=True), keep_default=False)

        # Adding field 'EquipmentResult.equipment'
        db.add_column('lab_equipmentresult', 'equipment', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lab.Equipment']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EquipmentTask.created_by'
        db.delete_column('lab_equipmenttask', 'created_by_id')

        # Deleting field 'EquipmentTask.status'
        db.delete_column('lab_equipmenttask', 'status')

        # Deleting field 'EquipmentResult.created'
        db.delete_column('lab_equipmentresult', 'created')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 24, 8, 40, 6, 288994)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 24, 8, 40, 6, 259589)'})
        },
