...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sampling.execution_type_group'
        db.add_column('lab_sampling', 'execution_type_group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['service.ExecutionTypeGroup']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sampling.execution_type_group'
        db.delete_column('lab_sampling', 'execution_type_group_id')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 11, 8, 15, 521419)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 11, 8, 15, 549538)'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 11, 8, 15, 412697)', 'null': 'True', 'blank': 'True'}),
