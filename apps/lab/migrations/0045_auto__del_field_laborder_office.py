...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'LabOrder.office'
        raise RuntimeError("Cannot reverse this migration. 'LabOrder.office' and its values cannot be restored.")
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 6, 10, 52, 22, 122694)'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 6, 10, 52, 21, 618615)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 6, 10, 52, 21, 688878)', 'null': 'True', 'blank': 'True'}),
