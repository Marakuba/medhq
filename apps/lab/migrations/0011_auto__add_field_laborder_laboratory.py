...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.laboratory'
        db.add_column('lab_laborder', 'laboratory', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['state.State']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabOrder.laboratory'
        db.delete_column('lab_laborder', 'laboratory_id')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 4, 8, 23, 31, 335334)'}),
