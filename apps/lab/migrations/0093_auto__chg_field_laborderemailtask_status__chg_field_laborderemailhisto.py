...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabOrderEmailTask.status'
        db.alter_column('lab_laborderemailtask', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'LabOrderEmailHistory.status'
        db.alter_column('lab_laborderemailhistory', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'LabOrderEmailTask.status'
        db.alter_column('lab_laborderemailtask', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'LabOrderEmailHistory.status'
        db.alter_column('lab_laborderemailhistory', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 11, 52, 5, 653770)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 11, 52, 5, 630278)'})
        },
