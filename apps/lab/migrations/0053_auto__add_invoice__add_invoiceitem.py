...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_invoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_invoice', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.State'])),
        ))
        db.send_create_signal('lab', ['Invoice'])

        # Adding model 'InvoiceItem'
        db.create_table('lab_invoiceitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='operator_in_invoice_item', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ordered_service', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['visit.OrderedService'], unique=True)),
        ))
        db.send_create_signal('lab', ['InvoiceItem'])


    def backwards(self, orm):
        
        # Deleting model 'Invoice'
        db.delete_table('lab_invoice')

        # Deleting model 'InvoiceItem'
        db.delete_table('lab_invoiceitem')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 18, 9, 11, 43, 473670)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 18, 9, 11, 43, 270439)'})
        },
        ...
        'visit.orderedservice': {
            ...
            'print_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'sample': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'sample'", 'unique': 'True', 'null': 'True', 'to': "orm['lab.Sampling']"}),
