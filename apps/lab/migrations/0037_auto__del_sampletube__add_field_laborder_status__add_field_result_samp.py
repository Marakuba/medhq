...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.status'
        db.add_column('lab_laborder', 'status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.Status'], null=True, blank=True), keep_default=False)

        # Adding field 'Result.sample'
        db.add_column('lab_result', 'sample', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Sampling'], null=True, blank=True), keep_default=False)

        # Adding field 'Result.status'
        db.add_column('lab_result', 'status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.Status'], null=True, blank=True), keep_default=False)

        # Adding field 'Sampling.status'
        db.add_column('lab_sampling', 'status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.Status'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LabOrder.status'
        db.delete_column('lab_laborder', 'status_id')

        # Deleting field 'Result.sample'
        db.delete_column('lab_result', 'sample_id')

        # Deleting field 'Result.status'
        db.delete_column('lab_result', 'status_id')

        # Deleting field 'Sampling.status'
        db.delete_column('lab_sampling', 'status_id')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 2, 16, 24, 36, 883236)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 2, 16, 24, 36, 842669)', 'null': 'True', 'blank': 'True'}),
