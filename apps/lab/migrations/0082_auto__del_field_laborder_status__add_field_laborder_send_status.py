...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lab_laborder', 'send_status', self.gf('django.db.models.fields.CharField')(default='ready', max_length=10), keep_default=False)
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'send_status': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 8, 24, 12, 205981)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 8, 24, 11, 890845)'})
        },
