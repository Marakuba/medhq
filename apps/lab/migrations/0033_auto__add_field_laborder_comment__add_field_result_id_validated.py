...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.comment'
        db.add_column('lab_laborder', 'comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Result.id_validated'
        db.add_column('lab_result', 'id_validated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabOrder.comment'
        db.delete_column('lab_laborder', 'comment')

        # Deleting field 'Result.id_validated'
        db.delete_column('lab_result', 'id_validated')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 1, 22, 45, 45, 823406)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lab.result': {
            ...
            'analysis': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab.Analysis']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_validated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'lab.sampling': {
            ...
            'ordered_services': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['visit.OrderedService']", 'symmetrical': 'False'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 1, 22, 45, 45, 783572)', 'null': 'True', 'blank': 'True'}),
