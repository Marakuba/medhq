...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('lab_analysis', 'transport_tube', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transport_tube', null=True, to=orm['lab.Tube'], blank=True), keep_default=False)

        # Adding field 'Analysis.normal_tube'
        db.add_column('lab_analysis', 'normal_tube', self.gf('django.db.models.fields.related.ForeignKey')(related_name='normal_tube', null=True, to=orm['lab.Tube'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 1, 11, 22, 57, 671636)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 1, 11, 22, 57, 628214)', 'null': 'True', 'blank': 'True'}),
