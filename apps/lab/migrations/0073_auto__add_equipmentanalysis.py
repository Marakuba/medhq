...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EquipmentAnalysis'
        db.create_table('lab_equipmentanalysis', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('analysis', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lab.Analysis'], unique=True)),
        ))
        db.send_create_signal('lab', ['EquipmentAnalysis'])


    def backwards(self, orm):
        
        # Deleting model 'EquipmentAnalysis'
        db.delete_table('lab_equipmentanalysis')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 11, 24, 46, 887699)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 11, 24, 46, 626719)'})
        },
