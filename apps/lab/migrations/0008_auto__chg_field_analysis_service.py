...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Analysis.service'
        db.alter_column('lab_analysis', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Analysis.service'
        db.alter_column('lab_analysis', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService']))
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 22, 0, 36, 26, 853147)'}),
