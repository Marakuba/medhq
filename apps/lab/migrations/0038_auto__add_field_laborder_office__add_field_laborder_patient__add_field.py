...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.office'
        db.add_column('lab_laborder', 'office', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='office', to=orm['state.State']), keep_default=False)

        # Adding field 'LabOrder.patient'
        db.add_column('lab_laborder', 'patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.Patient'], null=True, blank=True), keep_default=False)

        # Adding field 'LabOrder.lab_group'
        db.add_column('lab_laborder', 'lab_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.LabServiceGroup'], null=True, blank=True), keep_default=False)

        # Adding field 'LabOrder.printed_by'
        db.add_column('lab_laborder', 'printed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Changing field 'LabOrder.visit'
        db.alter_column('lab_laborder', 'visit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Visit'], null=True))

        # Adding field 'Sampling.created'
        db.add_column('lab_sampling', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 3, 12, 5, 26, 949936)), keep_default=False)

        # Adding field 'Sampling.laboratory'
        db.add_column('lab_sampling', 'laboratory', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['state.State']), keep_default=False)

        # Changing field 'Sampling.visit'
        db.alter_column('lab_sampling', 'visit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Visit'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'LabOrder.office'
        db.delete_column('lab_laborder', 'office_id')

        # Deleting field 'LabOrder.patient'
        db.delete_column('lab_laborder', 'patient_id')

        # Deleting field 'LabOrder.lab_group'
        db.delete_column('lab_laborder', 'lab_group_id')

        # Deleting field 'LabOrder.printed_by'
        db.delete_column('lab_laborder', 'printed_by_id')

        # User chose to not deal with backwards NULL issues for 'LabOrder.visit'
        raise RuntimeError("Cannot reverse this migration. 'LabOrder.visit' and its values cannot be restored.")

        # Deleting field 'Sampling.created'
        db.delete_column('lab_sampling', 'created')

        # Deleting field 'Sampling.laboratory'
        db.delete_column('lab_sampling', 'laboratory_id')

        # User chose to not deal with backwards NULL issues for 'Sampling.visit'
        raise RuntimeError("Cannot reverse this migration. 'Sampling.visit' and its values cannot be restored.")
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 3, 12, 5, 26, 944513)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 3, 12, 5, 26, 949936)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 3, 12, 5, 26, 915268)', 'null': 'True', 'blank': 'True'}),
