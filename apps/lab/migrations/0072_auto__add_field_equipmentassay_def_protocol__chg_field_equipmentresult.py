...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentAssay.def_protocol'
        db.add_column('lab_equipmentassay', 'def_protocol', self.gf('django.db.models.fields.CharField')(default='UNDILUTED', max_length=20), keep_default=False)

        # Changing field 'EquipmentResult.abnormal_flags'
        db.alter_column('lab_equipmentresult', 'abnormal_flags', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Deleting field 'EquipmentAssay.def_protocol'
        db.delete_column('lab_equipmentassay', 'def_protocol')

        # Changing field 'EquipmentResult.abnormal_flags'
        db.alter_column('lab_equipmentresult', 'abnormal_flags', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 6, 14, 57, 7, 635071)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 6, 14, 57, 7, 601894)'})
        },
