...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('lab_laborder', 'new_staff', self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_staff_pos', null=True, to=orm['staff.Position'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 22, 15, 15, 29, 931302)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 22, 15, 15, 29, 901890)'})
        },
