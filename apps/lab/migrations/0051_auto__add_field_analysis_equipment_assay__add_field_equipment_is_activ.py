...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Analysis.equipment_assay'
        db.add_column('lab_analysis', 'equipment_assay', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.EquipmentAssay'], null=True, blank=True), keep_default=False)

        # Adding field 'Equipment.is_active'
        db.add_column('lab_equipment', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Equipment.order'
        db.add_column('lab_equipment', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'EquipmentTask.completed'
        db.add_column('lab_equipmenttask', 'completed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Analysis.equipment_assay'
        db.delete_column('lab_analysis', 'equipment_assay_id')

        # Deleting field 'Equipment.is_active'
        db.delete_column('lab_equipment', 'is_active')

        # Deleting field 'Equipment.order'
        db.delete_column('lab_equipment', 'order')

        # Deleting field 'EquipmentTask.completed'
        db.delete_column('lab_equipmenttask', 'completed')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 8, 13, 11, 8, 963653)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 8, 13, 11, 8, 699912)'})
        },
