...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lab_result', 'value', self.gf('django.db.models.fields.CharField')(default=u'', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Result.value'
        db.delete_column('lab_result', 'value')
    ...
    models = {
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 25, 11, 28, 18, 543853)'}),
