...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('lab_laborder', 'staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.Staff'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 9, 21, 21, 38, 483437)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 9, 21, 21, 38, 457606)'}),
