...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ReferenceRange'
        db.delete_table('lab_referencerange')

        # Deleting model 'Factor'
        db.delete_table('lab_factor')

        # Adding model 'RefRange'
        db.create_table('lab_refrange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('analysis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Analysis'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('age_from', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('age_to', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('pregnance_from', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('pregnance_to', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('min_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('result', self.gf('django.db.models.fields.SmallIntegerField')(max_length=1)),
        ))
        db.send_create_signal('lab', ['RefRange'])

        # Adding field 'Analysis.by_age'
        db.add_column('lab_analysis', 'by_age', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Analysis.by_gender'
        db.add_column('lab_analysis', 'by_gender', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Analysis.by_pregnancy'
        db.add_column('lab_analysis', 'by_pregnancy', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'EquipmentAssay.is_active'
        db.add_column('lab_equipmentassay', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Result.previous_value'
        db.add_column('lab_result', 'previous_value', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Result.modified'
        db.add_column('lab_result', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 7, 12), blank=True), keep_default=False)

        # Adding field 'Result.modified_by'
        db.add_column('lab_result', 'modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'ReferenceRange'
        db.create_table('lab_referencerange', (
            ('operator1', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('operator2', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('analysis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Analysis'])),
            ('value2', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('value1', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('lab', ['ReferenceRange'])

        # Adding model 'Factor'
        db.create_table('lab_factor', (
            ('ref_range', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.ReferenceRange'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('operator', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('lab', ['Factor'])

        # Deleting model 'RefRange'
        db.delete_table('lab_refrange')

        # Deleting field 'Analysis.by_age'
        db.delete_column('lab_analysis', 'by_age')

        # Deleting field 'Analysis.by_gender'
        db.delete_column('lab_analysis', 'by_gender')

        # Deleting field 'Analysis.by_pregnancy'
        db.delete_column('lab_analysis', 'by_pregnancy')

        # Deleting field 'EquipmentAssay.is_active'
        db.delete_column('lab_equipmentassay', 'is_active')

        # Deleting field 'Result.previous_value'
        db.delete_column('lab_result', 'previous_value')

        # Deleting field 'Result.modified'
        db.delete_column('lab_result', 'modified')

        # Deleting field 'Result.modified_by'
        db.delete_column('lab_result', 'modified_by_id')
    ...
    models = {
        ...
        'lab.equipment': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'lab.equipmentresult': {
            ...
            'assay': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measurement': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'order': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 12, 19, 47, 22, 782437)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 12, 19, 47, 22, 529511)'})
        },
