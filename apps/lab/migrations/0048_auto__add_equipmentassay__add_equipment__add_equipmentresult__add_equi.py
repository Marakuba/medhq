...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EquipmentAssay'
        db.create_table('lab_equipmentassay', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Equipment'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'])),
        ))
        db.send_create_signal('lab', ['EquipmentAssay'])

        # Adding model 'Equipment'
        db.create_table('lab_equipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('lab', ['Equipment'])

        # Adding model 'EquipmentResult'
        db.create_table('lab_equipmentresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('assay', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('result', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('measurement', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('lab', ['EquipmentResult'])

        # Adding model 'EquipmentTask'
        db.create_table('lab_equipmenttask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('equipment_assay', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.EquipmentAssay'])),
            ('ordered_service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.OrderedService'])),
        ))
        db.send_create_signal('lab', ['EquipmentTask'])


    def backwards(self, orm):
        
        # Deleting model 'EquipmentAssay'
        db.delete_table('lab_equipmentassay')

        # Deleting model 'Equipment'
        db.delete_table('lab_equipment')

        # Deleting model 'EquipmentResult'
        db.delete_table('lab_equipmentresult')

        # Deleting model 'EquipmentTask'
        db.delete_table('lab_equipmenttask')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 8, 8, 41, 54, 449714)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 8, 8, 41, 54, 185303)'})
        },
