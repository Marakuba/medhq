...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sampling.number'
        db.add_column('lab_sampling', 'number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['numeration.NumeratorItem'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sampling.number'
        db.delete_column('lab_sampling', 'number_id')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 35, 59, 134094)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 35, 59, 138337)'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 35, 59, 51184)'})
        },
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 20, 10, 35, 59, 92356)', 'null': 'True', 'blank': 'True'}),
