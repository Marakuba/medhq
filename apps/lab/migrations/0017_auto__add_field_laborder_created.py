...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabOrder.created'
        db.add_column('lab_laborder', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 12, 7, 23, 55, 6, 913027)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabOrder.created'
        db.delete_column('lab_laborder', 'created')
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 7, 23, 55, 6, 913027)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 7, 23, 55, 6, 888404)'}),
