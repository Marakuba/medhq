...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LabOrderEmailTask'
        db.create_table('lab_laborderemailtask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('sent', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('lab_order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lab.LabOrder'], unique=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default=u'ready', max_length=1)),
        ))
        db.send_create_signal('lab', ['LabOrderEmailTask'])

        # Adding model 'LabOrderEmailHistory'
        db.create_table('lab_laborderemailhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_tast', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.LabOrderEmailTask'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('lab', ['LabOrderEmailHistory'])

        # Deleting field 'LabOrder.sended'
        db.delete_column('lab_laborder', 'sended')

        # Deleting field 'LabOrder.send_status'
        db.delete_column('lab_laborder', 'send_status')


    def backwards(self, orm):
        
        # Deleting model 'LabOrderEmailTask'
        db.delete_table('lab_laborderemailtask')

        # Deleting model 'LabOrderEmailHistory'
        db.delete_table('lab_laborderemailhistory')

        # Adding field 'LabOrder.sended'
        db.add_column('lab_laborder', 'sended', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'LabOrder.send_status'
        db.add_column('lab_laborder', 'send_status', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)
    ...
    models = {
        ...
        'lab.laborderemailhistory': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email_tast': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab.LabOrderEmailTask']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lab.laborderemailtask': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "u'ready'", 'max_length': '1'})
        },
        'lab.labservice': {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 11, 45, 44, 103685)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 11, 45, 44, 80512)'})
        },
