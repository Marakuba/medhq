...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabOrder.staff'
        db.alter_column('lab_laborder', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.Staff'], null=True))


    def backwards(self, orm):
        
        # Changing field 'LabOrder.staff'
        db.alter_column('lab_laborder', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['state.Staff']))
    ...
    models = {
        ...
        'lab.laborder': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 7, 20, 47, 56, 955585)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'visit.visit': {
            ...
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 7, 20, 47, 56, 934997)'}),
