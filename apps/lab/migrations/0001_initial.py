...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_measurement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('lab', ['Measurement'])

        # Adding model 'InputMask'
        db.create_table('lab_inputmask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('lab', ['InputMask'])

        # Adding model 'Analysis'
        db.create_table('lab_analysis', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('input_mask', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.InputMask'])),
            ('measurement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Measurement'])),
        ))
        db.send_create_signal('lab', ['Analysis'])
        ...
        db.create_table('lab_laborder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Visit'])),
        ))
        db.send_create_signal('lab', ['LabOrder'])

        # Adding model 'Result'
        db.create_table('lab_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.LabOrder'])),
            ('analysis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Analysis'])),
        ))
        db.send_create_signal('lab', ['Result'])


    def backwards(self, orm):
        
        # Deleting model 'Measurement'
        db.delete_table('lab_measurement')

        # Deleting model 'InputMask'
        db.delete_table('lab_inputmask')

        # Deleting model 'Analysis'
        db.delete_table('lab_analysis')
    ...
    models = {
        ...
        'lab.analysis': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_mask': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab.InputMask']"}),
            'measurement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab.Measurement']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'visit.visit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'on_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 25, 11, 20, 49, 16280)'}),
