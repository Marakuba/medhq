...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentAssay.equipment_analysis'
        db.add_column('lab_equipmentassay', 'equipment_analysis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.EquipmentAnalysis'], null=True, blank=True), keep_default=False)

        # Changing field 'EquipmentAssay.service'
        db.alter_column('lab_equipmentassay', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.BaseService'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'EquipmentAssay.equipment_analysis'
        db.delete_column('lab_equipmentassay', 'equipment_analysis_id')

        # User chose to not deal with backwards NULL issues for 'EquipmentAssay.service'
        raise RuntimeError("Cannot reverse this migration. 'EquipmentAssay.service' and its values cannot be restored.")
    ...
    models = {
        ...
        'lab.equipmentanalysis': {
            'Meta': {'object_name': 'EquipmentAnalysis'},
        ...
        'lab.equipmentassay': {
            ...
            'def_protocol': ('django.db.models.fields.CharField', [], {'default': "'UNDILUTED'", 'max_length': '20'}),
        ...
        'lab.equipmenttask': {
            ...
            'assay_protocol': ('django.db.models.fields.CharField', [], {'default': "'UNDILUTED'", 'max_length': '20'}),
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 11, 26, 18, 181945)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 11, 26, 18, 145295)'})
        },
