...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentTask.result'
        db.add_column('lab_equipmenttask', 'result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab.Result'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EquipmentTask.result'
        db.delete_column('lab_equipmenttask', 'result_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 9, 35, 32, 640403)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 9, 35, 32, 610432)'})
        },
