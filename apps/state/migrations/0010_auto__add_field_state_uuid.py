...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'State.uuid'
        db.add_column('state_state', 'uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'State.uuid'
        db.delete_column('state_state', 'uuid')
