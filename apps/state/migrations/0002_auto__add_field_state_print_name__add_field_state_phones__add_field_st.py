...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'State.print_name'
        db.add_column('state_state', 'print_name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200), keep_default=False)

        # Adding field 'State.phones'
        db.add_column('state_state', 'phones', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'State.licenses'
        db.add_column('state_state', 'licenses', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)

        # Adding field 'State.inn'
        db.add_column('state_state', 'inn', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=0, blank=True), keep_default=False)

        # Adding field 'State.kpp'
        db.add_column('state_state', 'kpp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=0, blank=True), keep_default=False)

        # Adding field 'State.ogrn'
        db.add_column('state_state', 'ogrn', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=0, blank=True), keep_default=False)

        # Adding field 'State.bank_details'
        db.add_column('state_state', 'bank_details', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'State.print_name'
        db.delete_column('state_state', 'print_name')

        # Deleting field 'State.phones'
        db.delete_column('state_state', 'phones')

        # Deleting field 'State.licenses'
        db.delete_column('state_state', 'licenses')

        # Deleting field 'State.inn'
        db.delete_column('state_state', 'inn')

        # Deleting field 'State.kpp'
        db.delete_column('state_state', 'kpp')

        # Deleting field 'State.ogrn'
        db.delete_column('state_state', 'ogrn')

        # Deleting field 'State.bank_details'
        db.delete_column('state_state', 'bank_details')
