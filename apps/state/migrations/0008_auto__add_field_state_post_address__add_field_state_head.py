...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'State.post_address'
        db.add_column('state_state', 'post_address', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'State.head'
        db.add_column('state_state', 'head', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'State.post_address'
        db.delete_column('state_state', 'post_address')

        # Deleting field 'State.head'
        db.delete_column('state_state', 'head')
