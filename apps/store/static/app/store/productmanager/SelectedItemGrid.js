Ext.ns('App.productmanager');



App.productmanager.SelectedItemGrid = Ext.extend(Ext.grid.GridPanel, {

    origTitle: 'Отмеченные материалы',
    ...
    initComponent : function() {
        ...
        App.productmanager.SelectedItemGrid.superclass.initComponent.apply(this, arguments);
    ...
    onChange: function(){
        ...
        if (record) {
            this.fireEvent('openitem',record);
        }
    },
