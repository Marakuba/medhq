...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Staff.id_card_type'
        db.add_column('staff_staff', 'id_card_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'Staff.id_card_series'
        db.add_column('staff_staff', 'id_card_series', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'Staff.id_card_number'
        db.add_column('staff_staff', 'id_card_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Staff.id_card_issue_date'
        db.add_column('staff_staff', 'id_card_issue_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Staff.id_card_org'
        db.add_column('staff_staff', 'id_card_org', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Staff.id_card_type'
        db.delete_column('staff_staff', 'id_card_type')

        # Deleting field 'Staff.id_card_series'
        db.delete_column('staff_staff', 'id_card_series')

        # Deleting field 'Staff.id_card_number'
        db.delete_column('staff_staff', 'id_card_number')

        # Deleting field 'Staff.id_card_issue_date'
        db.delete_column('staff_staff', 'id_card_issue_date')

        # Deleting field 'Staff.id_card_org'
        db.delete_column('staff_staff', 'id_card_org')
