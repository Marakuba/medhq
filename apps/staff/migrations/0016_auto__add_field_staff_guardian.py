...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Staff.guardian'
        db.add_column('staff_staff', 'guardian', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Staff.guardian'
        db.delete_column('staff_staff', 'guardian')
