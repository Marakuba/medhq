...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.routine'
        db.add_column('staff_staff', 'routine',
                      self.gf('django.db.models.fields.CharField')(default='\xd0\xb4', max_length=1),
                      keep_default=False)

        # Adding field 'Position.is_active'
        db.add_column('staff_position', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Staff.routine'
        db.delete_column('staff_staff', 'routine')

        # Deleting field 'Position.is_active'
        db.delete_column('staff_position', 'is_active')
    ...
    models = {
        ...
        'staff.staff': {
            ...
            'routine': ('django.db.models.fields.CharField', [], {'default': "'\\xd0\\xb4'", 'max_length': '1'}),
