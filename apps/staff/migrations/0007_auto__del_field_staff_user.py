...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('staff_staff', 'user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='staff_user', unique=True, null=True, to=orm['auth.User'], blank=True), keep_default=False)
