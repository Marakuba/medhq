...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Staff.id_card_org'
        db.alter_column('staff_staff', 'id_card_org', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
    def backwards(self, orm):

        # Changing field 'Staff.id_card_org'
        db.alter_column('staff_staff', 'id_card_org', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    models = {
        'auth.group': {
