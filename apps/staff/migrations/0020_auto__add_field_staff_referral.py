...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.referral'
        db.add_column('staff_staff', 'referral',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['visit.Referral'], unique=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Staff.referral'
        db.delete_column('staff_staff', 'referral_id')
