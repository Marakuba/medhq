...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Staff.user'
        db.add_column('staff_staff', 'user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='staff_user', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Staff.user'
        db.delete_column('staff_staff', 'user_id')
    ...
    models = {
        ...
        'staff.staff': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'staff_user'", 'null': 'True', 'to': "orm['auth.User']"}),
