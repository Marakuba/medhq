...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Doctor.pm_session_starts'
        db.alter_column('staff_doctor', 'pm_session_starts', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Doctor.am_session_ends'
        db.alter_column('staff_doctor', 'am_session_ends', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Doctor.am_session_starts'
        db.alter_column('staff_doctor', 'am_session_starts', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Doctor.pm_session_ends'
        db.alter_column('staff_doctor', 'pm_session_ends', self.gf('django.db.models.fields.TimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Doctor.pm_session_starts'
        db.alter_column('staff_doctor', 'pm_session_starts', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Doctor.am_session_ends'
        db.alter_column('staff_doctor', 'am_session_ends', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Doctor.am_session_starts'
        db.alter_column('staff_doctor', 'am_session_starts', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Doctor.pm_session_ends'
        db.alter_column('staff_doctor', 'pm_session_ends', self.gf('django.db.models.fields.DateTimeField')(null=True))
