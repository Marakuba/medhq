...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Doctor.comment'
        db.alter_column('staff_doctor', 'comment', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Doctor.comment'
        raise RuntimeError("Cannot reverse this migration. 'Doctor.comment' and its values cannot be restored.")
