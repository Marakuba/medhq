...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('staff_staff', 'user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='staff_user', unique=True, null=True, to=orm['auth.User']), keep_default=False)
