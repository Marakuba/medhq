...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Doctor'
        db.create_table('staff_doctor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('staff', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['staff.Staff'], unique=True)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('timeslot', self.gf('django.db.models.fields.PositiveIntegerField')(default=4)),
            ('routine', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('am_session_starts', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('am_session_ends', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('pm_session_starts', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('pm_session_ends', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('work_days', self.gf('tagging.fields.TagField')(max_length=255, blank=True)),
            ('room', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('staff', ['Doctor'])


    def backwards(self, orm):
        
        # Deleting model 'Doctor'
        db.delete_table('staff_doctor')
    ...
    models = {
        ...
        'staff.doctor': {
            ...
            'am_session_ends': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'am_session_starts': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pm_session_ends': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'pm_session_starts': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'room': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'routine': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            ...
            'work_days': ('tagging.fields.TagField', [], {'max_length': '255', 'blank': 'True'})
        },
        'staff.position': {
