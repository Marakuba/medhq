...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RejectionCause'
        db.create_table('scheduler_rejectioncause', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('scheduler', ['RejectionCause'])

        # Adding field 'Preorder.rejection_cause'
        db.add_column('scheduler_preorder', 'rejection_cause',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scheduler.RejectionCause'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'RejectionCause'
        db.delete_table('scheduler_rejectioncause')

        # Deleting field 'Preorder.rejection_cause'
        db.delete_column('scheduler_preorder', 'rejection_cause_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 0, 0)'})
        },
