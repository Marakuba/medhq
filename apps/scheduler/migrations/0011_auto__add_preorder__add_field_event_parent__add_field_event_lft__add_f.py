...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scheduler_preorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.Patient'], null=True, blank=True)),
            ('timeslot', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.Event'], unique=True)),
        ))
        db.send_create_signal('scheduler', ['Preorder'])

        # Adding field 'Event.parent'
        db.add_column('scheduler_event', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['scheduler.Event']), keep_default=False)

        # Adding field 'Event.lft'
        db.add_column('scheduler_event', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)

        # Adding field 'Event.rght'
        db.add_column('scheduler_event', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)

        # Adding field 'Event.tree_id'
        db.add_column('scheduler_event', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)

        # Adding field 'Event.level'
        db.add_column('scheduler_event', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Preorder'
        db.delete_table('scheduler_preorder')

        # Deleting field 'Event.parent'
        db.delete_column('scheduler_event', 'parent_id')

        # Deleting field 'Event.lft'
        db.delete_column('scheduler_event', 'lft')

        # Deleting field 'Event.rght'
        db.delete_column('scheduler_event', 'rght')

        # Deleting field 'Event.tree_id'
        db.delete_column('scheduler_event', 'tree_id')

        # Deleting field 'Event.level'
        db.delete_column('scheduler_event', 'level')
    ...
    models = {
        ...
        'scheduler.event': {
            ...
            'sid': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'scheduler.preorder': {
            ...
            'timeslot': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['scheduler.Event']", 'unique': 'True'})
        },
        'staff.staff': {
