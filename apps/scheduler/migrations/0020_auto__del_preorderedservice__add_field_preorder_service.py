...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'PreorderedService'
        db.delete_table('scheduler_preorderedservice')

        # Adding field 'Preorder.service'
        db.add_column('scheduler_preorder', 'service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ExtendedService'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'PreorderedService'
        db.create_table('scheduler_preorderedservice', (
            ('count', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('preorder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scheduler.Preorder'])),
        ...
        db.send_create_signal('scheduler', ['PreorderedService'])

        # Deleting field 'Preorder.service'
        db.delete_column('scheduler_preorder', 'service_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 27, 10, 31, 50, 97570)'})
        },
