...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.staff'
        db.alter_column('scheduler_event', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Event.staff'
        db.alter_column('scheduler_event', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Staff'], null=True))
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 17, 15, 9, 54, 317464)'})
        },
