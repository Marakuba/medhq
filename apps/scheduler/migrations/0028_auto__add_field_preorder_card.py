...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preorder.card'
        db.add_column('scheduler_preorder', 'card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['examination.Card'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preorder.card'
        db.delete_column('scheduler_preorder', 'card_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 3, 12, 4, 30, 230765)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 3, 12, 4, 30, 179357)'})
        },
