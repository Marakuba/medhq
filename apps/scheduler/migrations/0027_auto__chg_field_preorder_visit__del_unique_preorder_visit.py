...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Preorder', fields ['visit']
        db.delete_unique('scheduler_preorder', ['visit_id'])

        # Changing field 'Preorder.visit'
        db.alter_column('scheduler_preorder', 'visit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Visit'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Preorder.visit'
        db.alter_column('scheduler_preorder', 'visit_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['visit.Visit'], unique=True, null=True))

        # Adding unique constraint on 'Preorder', fields ['visit']
        db.create_unique('scheduler_preorder', ['visit_id'])
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 20, 15, 19, 23, 680465)'})
        },
