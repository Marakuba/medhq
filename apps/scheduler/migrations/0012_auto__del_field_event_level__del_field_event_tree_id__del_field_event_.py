...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Event.level'
        raise RuntimeError("Cannot reverse this migration. 'Event.level' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Event.tree_id'
        raise RuntimeError("Cannot reverse this migration. 'Event.tree_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Event.lft'
        raise RuntimeError("Cannot reverse this migration. 'Event.lft' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Event.rght'
        raise RuntimeError("Cannot reverse this migration. 'Event.rght' and its values cannot be restored.")
