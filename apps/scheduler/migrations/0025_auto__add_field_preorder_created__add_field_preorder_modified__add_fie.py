...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preorder.created'
        db.add_column('scheduler_preorder', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 12, 16, 13, 45, 9, 948042), blank=True), keep_default=False)

        # Adding field 'Preorder.modified'
        db.add_column('scheduler_preorder', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 12, 16, 15, 20, 48, 478478), blank=True), keep_default=False)

        # Adding field 'Preorder.operator'
        db.add_column('scheduler_preorder', 'operator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='operator_in_preorder', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Preorder.promotion'
        db.add_column('scheduler_preorder', 'promotion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotion.Promotion'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preorder.created'
        db.delete_column('scheduler_preorder', 'created')

        # Deleting field 'Preorder.modified'
        db.delete_column('scheduler_preorder', 'modified')

        # Deleting field 'Preorder.operator'
        db.delete_column('scheduler_preorder', 'operator_id')

        # Deleting field 'Preorder.promotion'
        db.delete_column('scheduler_preorder', 'promotion_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 16, 13, 44, 14, 448207)'})
        },
        ...
        'scheduler.preorder': {
            ...
            'visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['visit.Visit']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'service.baseservice': {
