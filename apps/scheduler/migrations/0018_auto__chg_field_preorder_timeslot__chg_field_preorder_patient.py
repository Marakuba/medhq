...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Preorder.timeslot'
        db.alter_column('scheduler_preorder', 'timeslot_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.Event'], unique=True, null=True))
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 16, 16, 36, 18, 350909)'})
        },
        'patient.patient': {
        ...
        'scheduler.preorderedservice': {
            'Meta': {'object_name': 'PreorderedService'},
            'count': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'execution_place': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['state.State']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'preorder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scheduler.Preorder']"}),
