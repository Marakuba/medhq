...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.shift'
        db.delete_column('scheduler_event', 'shift')

        # Adding field 'Event.timeslot'
        db.add_column('scheduler_event', 'timeslot', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Event.shift'
        db.add_column('scheduler_event', 'shift', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Event.timeslot'
        db.delete_column('scheduler_event', 'timeslot')
