...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preorder.referral'
        db.add_column('scheduler_preorder', 'referral',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visit.Referral'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Preorder.referral'
        db.delete_column('scheduler_preorder', 'referral_id')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 17, 0, 0)'})
        },
