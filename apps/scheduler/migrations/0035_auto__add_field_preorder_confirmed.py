...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Preorder.confirmed'
        db.add_column('scheduler_preorder', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Preorder.confirmed'
        db.delete_column('scheduler_preorder', 'confirmed')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 13, 0, 0)'})
        },
