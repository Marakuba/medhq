...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scheduler_event', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'\u0441', max_length=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.status'
        db.delete_column('scheduler_event', 'status')
    ...
    models = {
        ...
        'lab.sampling': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 0, 0)'})
        },
