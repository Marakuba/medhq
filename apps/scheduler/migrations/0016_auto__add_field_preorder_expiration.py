...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preorder.expiration'
        db.add_column('scheduler_preorder', 'expiration', self.gf('scheduler.models.CustomDateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preorder.expiration'
        db.delete_column('scheduler_preorder', 'expiration')
