...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 15, 14, 10, 52, 168294)'})
        },
        'patient.patient': {
        ...
        'scheduler.preorder': {
            ...
            'timeslot': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['scheduler.Event']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
