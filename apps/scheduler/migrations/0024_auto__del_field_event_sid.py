...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.sid'
        db.delete_column('scheduler_event', 'sid')


    def backwards(self, orm):
        
        # Adding field 'Event.sid'
        db.add_column('scheduler_event', 'sid', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 17, 15, 41, 43, 502638)'})
        },
