...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Preorder.patient'
        db.alter_column('scheduler_preorder', 'patient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.Patient'], null=True))

        # Changing field 'Preorder.timeslot'
        db.alter_column('scheduler_preorder', 'timeslot_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['scheduler.Event']))


    def backwards(self, orm):
        
        # Changing field 'Preorder.patient'
        db.alter_column('scheduler_preorder', 'patient_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['patient.Patient']))

        # Changing field 'Preorder.timeslot'
        db.alter_column('scheduler_preorder', 'timeslot_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['scheduler.Event'], unique=True))
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 25, 15, 9, 19, 431433)'})
        },
        ...
        'scheduler.preorder': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['service.ExtendedService']", 'null': 'True'}),
            'timeslot': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'preorder'", 'unique': 'True', 'null': 'True', 'to': "orm['scheduler.Event']"}),
            'visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['visit.Visit']", 'unique': 'True', 'null': 'True'})
        },
        'service.baseservice': {
