...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('scheduler_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # Changing field 'Event.title'
        db.alter_column('scheduler_event', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
