...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preorder.visit'
        db.add_column('scheduler_preorder', 'visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['visit.Visit'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preorder.visit'
        db.delete_column('scheduler_preorder', 'visit_id')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 22, 12, 20, 16, 557791)'})
        },
