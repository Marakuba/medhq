...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preorder.payment_type'
        db.add_column('scheduler_preorder', 'payment_type', self.gf('django.db.models.fields.CharField')(default=u'\u043d', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preorder.payment_type'
        db.delete_column('scheduler_preorder', 'payment_type')
    ...
    models = {
        ...
        'numeration.numerator': {
            ...
            'valid_till': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 11, 30, 18, 181827)'})
        },
