...
class ClientItemResource(ExtResource):
    client = fields.OneToOneField('apps.apiutils.registry.PatientResource', 'client')
    def dehydrate(self, bundle):
...
class PatientResource(ExtResource):
    ...
    state = fields.ForeignKey('apiutils.registry.StateResource', 'state', null=True)
...
class ContractResource(ExtResource):
    ...
    state = fields.ForeignKey('apiutils.registry.OwnStateResource', 'state', null = True)
...
class RemoteStateResource(ModelResource):
    ...
    state = fields.ForeignKey('apps.apiutils.registry.StateResource', 'state')
...
#    lab_group = fields.ForeignKey(LabServiceGroupResource, 'lab_group', null=True)
    staff = fields.ForeignKey('apiutils.registry.PositionResource', 'staff', null=True)
...
class ResultResource(ExtResource):
    ...
    sample = fields.ForeignKey('apiutils.registry.SamplingResource', 'sample', null=True)
...
class OrderedServiceResource(ExtBatchResource):
    ...
    assigment = fields.ForeignKey('apps.apiutils.registry.PreorderResource', 'assigment', null=True)
...
class PreorderResource(ExtBatchResource):
    ...
    timeslot = fields.OneToOneField('apps.apiutils.registry.EventResource', 'timeslot', null=True)
...
class EventResource(ExtResource):
    staff = fields.ForeignKey(PositionResource, 'staff', null=True)
    #preord = fields.ToOneField('apps.apiutils.registry.PreorderResource', 'preord', null=True)
