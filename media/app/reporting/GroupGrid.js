...
App.reporting.GroupGrid = Ext.extend(Ext.grid.GridPanel, {

	initComponent : function() {
		
		this.proxy = new Ext.data.HttpProxy({
		    url: get_api_url('groups')
		});
		...
		this.reader = new Ext.data.JsonReader({
		    ...
		    {name: 'group_item', allowBlank: false},
		    {name: 'colspan', allowBlank: true},
		    {name: 'group_item_name', allowBlank: true}
		]);
		...
		this.editor = new Ext.ux.grid.RowEditor({
       		...
       		listeners:{
       			afteredit:function(editor,changes,rec,i){
       				rec.data.group_item = rec.data.group_item_name;
       				this.store.save();
       			},
       			scope:this
       		}
		...
		App.reporting.GroupGrid.superclass.initComponent.apply(this, arguments);
	},
...
Ext.reg('reportgroupgrid',App.reporting.GroupGrid);