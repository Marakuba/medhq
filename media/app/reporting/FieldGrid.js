...
App.reporting.FieldGrid = Ext.extend(Ext.grid.GridPanel, {

	initComponent : function() {
		
		this.proxy = new Ext.data.HttpProxy({
		    url: get_api_url('fields')
		});
		...
		this.reader = new Ext.data.JsonReader({
		    ...
		    {name: 'field_item', allowBlank: true},
		    {name: 'colspan', allowBlank: true},
		    {name: 'field_item_name', allowBlank: true}
		]);
		...
		this.editor = new Ext.ux.grid.RowEditor({
       		...
       		listeners:{
       			afteredit:function(editor,changes,rec,i){
       				rec.data.field_item = rec.data.field_item_name;
       				this.store.save();
       			},
       			scope:this
       		}
		...
		App.reporting.FieldGrid.superclass.initComponent.apply(this, arguments);
	},
...
Ext.reg('reportfieldgrid',App.reporting.FieldGrid);