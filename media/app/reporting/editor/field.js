...
Ext.ux.form.ReportField = Ext.extend(Ext.Panel,{
...
//	                	sectionEditor.completeEdit();
		...
		Ext.ux.form.ReportField.superclass.initComponent.apply(this, arguments);
...
Ext.reg('ticket', Ext.ux.form.ReportField);
