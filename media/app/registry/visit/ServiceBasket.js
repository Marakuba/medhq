...
App.visit.ServiceBasket = Ext.extend(Ext.grid.EditorGridPanel, {
...
//						Ext.getCmp('sampling-print-btn').enable();
		...
		Ext.apply(this, Ext.apply(this.initialConfig, config));
		App.visit.ServiceBasket.superclass.initComponent.apply(this, arguments);
...
Ext.reg('visitservicebasket', App.visit.ServiceBasket);