...
/**
    ...
    *      * clear {Boolean/Number/Object} : (optional) Allows you to set an internal callback that will
          ...
          o      *    wait {Number} : (optional) The number of milliseconds to wait before clearing
                 *    (defaults to {@link #autoClear}).

          o      *    anim {Number} : (optional) False to clear the status immediately once the callback
                 *    executes (defaults to true which fades the status out).

          o      *    useDefaults {Number} : (optional) False to completely clear the status text and iconCls
