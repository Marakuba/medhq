...
App.BarcodeCentralPanel = Ext.extend(Ext.Panel, {
	...
	initComponent: function(){
		...
		App.BarcodeCentralPanel.superclass.initComponent.apply(this, arguments);
...
Ext.reg('centralpanel', App.BarcodeCentralPanel);
