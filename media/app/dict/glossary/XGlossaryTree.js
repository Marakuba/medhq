    ...
    initComponent: function(){
        ...
        this.loader = new Ext.tree.TreeLoader({
            ...
            baseParams:this.baseParams || {
                format:'json',
                staff:this.staff ? App.utils.uriToId(this.staff) : WebApp.active_staff
            },
            scope:this,
    ...
    actionCallback:function(options, success, response) {
        ...
        switch(options.action) {
            ...
            case 'insertChild':
                ...
                options.node.attributes['resource_uri'] = App.utils.getApiUrl('examination','glossary')+'/'+o.objects.id;
                options.node.select();
            break;
        }
        //}}}
